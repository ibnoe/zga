...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#sales_order_open_sentoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/sales_order_open_sentview/index/' },
		}; 
		
		$('#sales_order_open_sentform').click(function(){$('#sales_order_open_sentform').ajaxForm(options);});
...
<h3 class="addtitle">New Sales Order Open Sent</h3>

<p>
<div id="sales_order_open_sentoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/sales_order_open_sentadd/submit" id="sales_order_open_sentform" class="addform">
