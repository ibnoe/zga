		...
		<form method="post" action="<?=current_url();?>" id="sales_invoicelistform" name="sales_invoicelistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['salesinvoice__date'];?></td><td><?=$row['salesinvoice__orderid'];?></td><td><?=$row['salesinvoice__donum'];?></td><td><?php if (isset($row['salesinvoice__deliveryorder_id']) && $row['salesinvoice__deliveryorder_id'] > 0) echo $row['deliveryorder__orderid'];?></td><td align='right'><?=number_format($row['salesinvoice__total'], 2);?></td><td><?=$row['salesinvoice__top'];?></td><td><?=$row['salesinvoice__lastupdate'];?></td><td><?=$row['salesinvoice__updatedby'];?></td>
