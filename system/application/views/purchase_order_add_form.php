...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#purchase_orderoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/purchase_orderview/index/' },
		}; 
		
		$('#purchase_orderform').click(function(){$('#purchase_orderform').ajaxForm(options);});
...
<h3 class="addtitle">New Purchase Order</h3>

<p>
<div id="purchase_orderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/purchase_orderadd/submit" id="purchase_orderform" class="addform">
