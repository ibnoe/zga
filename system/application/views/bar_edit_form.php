...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#baroutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#bareditform').click(function(){$('#bareditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Bar</h3>

<p>
<div id="baroutput"></div>
</p>

<form method="post" action="<?=site_url();?>/baredit/submit" id="bareditform" class="editform">
...
<td>Bar Code</td><td><?=form_input(array('name' => 'item__barcode', 'value' => $item__barcode, 'id' => 'item__barcode'));?></td></tr><tr class='basic'>
<td>Length</td><td><?=form_input(array('name' => 'item__length', 'value' => $item__length, 'id' => 'item__length'));?></td></tr><tr class='basic'>
<td>Press Type</td><td><?=form_input(array('name' => 'item__pressmodel', 'value' => $item__pressmodel, 'id' => 'item__pressmodel'));?></td></tr><tr class='basic'>
