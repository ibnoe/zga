		...
		<form method="post" action="<?=current_url();?>" id="supplier_3listform" name="supplier_3listform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td><a href="<?=base_url().'index.php/supplier_3view/index/'.$row['id'];?>"><img src="<?=base_url();?>resources/detail.png"></img></a></td>
					<td class='hidden'><?=$row['id'];?></td><td><?=anchor('supplier_3view/index/'.$row['id'], $row['supplier__idstring']);?></td><td><?=$row['supplier__firstname'];?></td><td><?=$row['supplier__lastname'];?></td><td><?=$row['supplier__address'];?></td><td><?=$row['supplier__phone'];?></td><td><?=$row['supplier__fax'];?></td><td><?=$row['supplier__npwp'];?></td><td><?=$row['supplier__email'];?></td><td><?=$row['supplier__firmtype'];?></td><td><?=$row['supplier__contactperson'];?></td><td><?=$row['supplier__hpcontactperson'];?></td><td><?=$row['supplier__barang'];?></td><td><?=$row['supplier__top'];?></td><td><?php if (isset($row['supplier__currency_id']) && $row['currency__name'] != "") echo anchor('currencyview/index/'.$row['supplier__currency_id'], $row['currency__name']);?></td><td><?=$row['supplier__rating'];?></td><td><?=$row['supplier__lastupdate'];?></td><td><?=$row['supplier__updatedby'];?></td>
