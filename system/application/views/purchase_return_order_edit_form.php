...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#purchase_return_orderoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#purchase_return_ordereditform').click(function(){$('#purchase_return_ordereditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Purchase Return Order</h3>

<p>
<div id="purchase_return_orderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/purchase_return_orderedit/submit" id="purchase_return_ordereditform" class="editform">
...
<td>Notes</td><td><?=form_textarea(array('name' => 'purchasereturnorder__notes', 'value' => $purchasereturnorder__notes, 'id' => 'purchasereturnorder__notes'));?></td></tr><tr class='basic'></tr><tr class='basic'></tr><tr class='basic'></tr><tr class='basic'></tr>
