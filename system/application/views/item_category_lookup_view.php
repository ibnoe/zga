		...
		<form method="post" action="<?=current_url();?>" id="item_categorylistform" name="item_categorylistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['itemcategory__name'];?></td><td><?=$row['itemcategory__notes'];?></td><td><?=$row['itemcategory__lastupdate'];?></td><td><?=$row['itemcategory__updatedby'];?></td>
