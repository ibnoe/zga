...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#manufacturing_order_already_doneoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/manufacturing_order_already_doneview/index/' },
		}; 
		
		$('#manufacturing_order_already_doneform').click(function(){$('#manufacturing_order_already_doneform').ajaxForm(options);});
...
<h3 class="addtitle">New Manufacturing Order Already Done</h3>

<p>
<div id="manufacturing_order_already_doneoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_order_already_doneadd/submit" id="manufacturing_order_already_doneform" class="addform">
