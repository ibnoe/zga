		...
		<form method="post" action="<?=current_url();?>" id="cash_banklistform" name="cash_banklistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['cashbank__name'];?></td><td><?php if (isset($row['cashbank__currency_id']) && $row['cashbank__currency_id'] > 0) echo $row['currency__name'];?></td><td><?php if (isset($row['cashbank__coa_id']) && $row['cashbank__coa_id'] > 0) echo $row['coa__name'];?></td><td><?=$row['cashbank__notes'];?></td><td><?=$row['cashbank__lastupdate'];?></td><td><?=$row['cashbank__updatedby'];?></td>
