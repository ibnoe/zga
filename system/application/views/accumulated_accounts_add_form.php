...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#accumulated_accountsoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/accumulated_accountsview/index/' },
		}; 
		
		$('#accumulated_accountsform').click(function(){$('#accumulated_accountsform').ajaxForm(options);});
...
<h3 class="addtitle">New Accumulated Accounts</h3>

<p>
<div id="accumulated_accountsoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/accumulated_accountsadd/submit" id="accumulated_accountsform" class="addform">
