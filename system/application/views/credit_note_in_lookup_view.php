		...
		<form method="post" action="<?=current_url();?>" id="credit_note_inlistform" name="credit_note_inlistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['creditnotein__creditnoteinid'];?></td><td><?=$row['creditnotein__date'];?></td><td><?=$row['creditnotein__expirydate'];?></td><td><?php if (isset($row['creditnotein__supplier_id']) && $row['creditnotein__supplier_id'] > 0) echo $row['supplier__firstname'];?></td><td><?php if (isset($row['creditnotein__coa_id']) && $row['creditnotein__coa_id'] > 0) echo $row['coa__name'];?></td><td><?php if (isset($row['creditnotein__currency_id']) && $row['creditnotein__currency_id'] > 0) echo $row['currency__name'];?></td><td align='right'><?=number_format($row['creditnotein__amount'], 2);?></td><td align='right'><?=number_format($row['creditnotein__amountused'], 2);?></td><td><?=$row['creditnotein__notes'];?></td><td><?php if ($row['creditnotein__usedflag'] != 0) echo 'Yes'; else echo '';?></td><td><?=$row['creditnotein__lastupdate'];?></td><td><?=$row['creditnotein__updatedby'];?></td>
