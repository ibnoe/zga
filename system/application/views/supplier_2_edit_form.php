...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#supplier_2output',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#supplier_2editform').click(function(){$('#supplier_2editform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Supplier 2</h3>

<p>
<div id="supplier_2output"></div>
</p>

<form method="post" action="<?=site_url();?>/supplier_2edit/submit" id="supplier_2editform" class="editform">
