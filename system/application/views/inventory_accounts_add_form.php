...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#inventory_accountsoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/inventory_accountsview/index/' },
		}; 
		
		$('#inventory_accountsform').click(function(){$('#inventory_accountsform').ajaxForm(options);});
...
<h3 class="addtitle">New Inventory Accounts</h3>

<p>
<div id="inventory_accountsoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/inventory_accountsadd/submit" id="inventory_accountsform" class="addform">
