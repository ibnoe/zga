...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#manufacturing_orderoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#manufacturing_ordereditform').click(function(){$('#manufacturing_ordereditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Manufacturing Order</h3>

<p>
<div id="manufacturing_orderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_orderedit/submit" id="manufacturing_ordereditform" class="editform">
