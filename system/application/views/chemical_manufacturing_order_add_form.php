...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#chemical_manufacturing_orderoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/chemical_manufacturing_orderview/index/' },
		}; 
		
		$('#chemical_manufacturing_orderform').click(function(){$('#chemical_manufacturing_orderform').ajaxForm(options);});
...
<h3 class="addtitle">New Chemical Manufacturing Order</h3>

<p>
<div id="chemical_manufacturing_orderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/chemical_manufacturing_orderadd/submit" id="chemical_manufacturing_orderform" class="addform">
