...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#supplier_2output',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/supplier_2view/index/' },
		}; 
		
		$('#supplier_2form').click(function(){$('#supplier_2form').ajaxForm(options);});
...
<h3 class="addtitle">New Supplier 2</h3>

<p>
<div id="supplier_2output"></div>
</p>

<form method="post" action="<?=site_url();?>/supplier_2add/submit" id="supplier_2form" class="addform">
