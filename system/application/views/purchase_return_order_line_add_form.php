...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#purchase_return_order_lineoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/purchase_return_order_lineview/index/' },
		}; 
		
		$('#purchase_return_order_lineform').click(function(){$('#purchase_return_order_lineform').ajaxForm(options);});
