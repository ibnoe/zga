		...
		<form method="post" action="<?=current_url();?>" id="marketing_officerlistform" name="marketing_officerlistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td><a href="<?=base_url().'index.php/marketing_officerview/index/'.$row['id'];?>"><img src="<?=base_url();?>resources/detail.png"></img></a></td>
					<td class='hidden'><?=$row['id'];?></td><td><?=anchor('marketing_officerview/index/'.$row['id'], $row['marketingofficer__idstring']);?></td><td><?=$row['marketingofficer__name'];?></td><td><?=$row['marketingofficer__notes'];?></td><td><?=$row['marketingofficer__lastupdate'];?></td><td><?=$row['marketingofficer__updatedby'];?></td>
