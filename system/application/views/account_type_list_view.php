		...
		<form method="post" action="<?=current_url();?>" id="account_typelistform" name="account_typelistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td><a href="<?=base_url().'index.php/account_typeview/index/'.$row['id'];?>"><img src="<?=base_url();?>resources/detail.png"></img></a></td>
					<td class='hidden'><?=$row['id'];?></td><td><?=anchor('account_typeview/index/'.$row['id'], $row['coatype__classtype']);?></td><td><?=$row['coatype__name'];?></td><td><?=$row['coatype__lastupdate'];?></td><td><?=$row['coatype__updatedby'];?></td>
