...
<?php if (false): ?>
$('#receive_items_line_viewchildtabs').tabs({ selected: 0});
<?php endif; ?>
});
...
function receive_items_line_viewconfirmdelete(delid, obj)
	{
		$('#receive_items_line_view-dialog-confirm').html('<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Are you sure?</p>', receive_items_line_viewconfirmdelete3(delid, obj));
	}
...
function receive_items_line_viewconfirmdelete2(delid, obj)
	...
	function receive_items_line_viewconfirmdelete3(delid, obj)
	{
		$( "#receive_items_line_view-dialog-confirm" ).dialog({
			resizable: false,			
			modal: true,
			buttons: {
				"Delete": function() {
					$( this ).dialog( "close" );
					receive_items_line_viewcalldeletefn3('receive_items_line_viewdelete', delid, 'receive_items_line_viewlist');
				},
				Cancel: function() {
					$( this ).dialog( "close" );
				}
...
function receive_items_line_viewcalldeletefn3(con, id, list)
	{
...
<h3 class="viewtitle">View Receive Items Line View</h3>
...
<br>
<div id="receive_items_line_viewbuttons">
<table align="center" class="viewtablebutton">
<tr>
<td class="edit"><input class="button" type="button" value="Edit" onclick="location.href='<?=site_url()."/receive_items_line_viewedit/index/".$receive_items_line_view_id;?>'"></td>
<td class="delete"><input class="button" type="button" value="Delete" onclick="receive_items_line_viewconfirmdelete(<?=$receive_items_line_view_id;?>, this);"></td>
<!--print button-->
</tr>
</table>
</div>
...
<div id="receive_items_line_viewchildtabs">
