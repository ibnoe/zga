...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#core_repairoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/core_repairview/index/' },
		}; 
		
		$('#core_repairform').click(function(){$('#core_repairform').ajaxForm(options);});
...
<h3 class="addtitle">New Core Repair</h3>

<p>
<div id="core_repairoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/core_repairadd/submit" id="core_repairform" class="addform">
