...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#inkoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/inkview/index/' },
		}; 
		
		$('#inkform').click(function(){$('#inkform').ajaxForm(options);});
...
<h3 class="addtitle">New Ink</h3>

<p>
<div id="inkoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/inkadd/submit" id="inkform" class="addform">
...
<tr class='basic'>
<td>Ink Code</td>
<td><?=form_input(array('name' => 'item__inkcode', 'value' => $item__inkcode, 'class' => 'basic', 'id' => 'item__inkcode'));?></td></tr>
<tr class='basic'>
<td>Weight</td>
<td><?=form_input(array('name' => 'item__weight', 'value' => $item__weight, 'class' => 'basic', 'id' => 'item__weight'));?></td></tr>
<tr class='basic'>
