...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#purchase_payment_line_viewoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/purchase_payment_line_viewview/index/' },
		}; 
		
		$('#purchase_payment_line_viewform').click(function(){$('#purchase_payment_line_viewform').ajaxForm(options);});
