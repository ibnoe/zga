...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#depreciation_accountsoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#depreciation_accountseditform').click(function(){$('#depreciation_accountseditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Depreciation Accounts</h3>

<p>
<div id="depreciation_accountsoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/depreciation_accountsedit/submit" id="depreciation_accountseditform" class="editform">
