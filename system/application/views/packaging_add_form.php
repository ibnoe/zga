...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#packagingoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/packagingview/index/' },
		}; 
		
		$('#packagingform').click(function(){$('#packagingform').ajaxForm(options);});
...
<h3 class="addtitle">New Packaging</h3>

<p>
<div id="packagingoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/packagingadd/submit" id="packagingform" class="addform">
...
<tr class='basic'>
<td>Packgaging Type</td>
<td><?=form_input(array('name' => 'item__packagingtype', 'value' => $item__packagingtype, 'class' => 'basic', 'id' => 'item__packagingtype'));?></td></tr>
<tr class='basic'>
