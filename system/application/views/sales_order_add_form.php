...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#sales_orderoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/sales_orderview/index/' },
		}; 
		
		$('#sales_orderform').click(function(){$('#sales_orderform').ajaxForm(options);});
...
<h3 class="addtitle">New Sales Order</h3>

<p>
<div id="sales_orderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/sales_orderadd/submit" id="sales_orderform" class="addform">
