		...
		<form method="post" action="<?=current_url();?>" id="purchase_return_invoicelistform" name="purchase_return_invoicelistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['purchasereturninvoice__date'];?></td><td><?=$row['purchasereturninvoice__purchasereturninvoiceid'];?></td><td><?php if (isset($row['purchasereturninvoice__purchasereturndelivery_id']) && $row['purchasereturninvoice__purchasereturndelivery_id'] > 0) echo $row['purchasereturndelivery__purchasereturndeliveryid'];?></td><td align='right'><?=number_format($row['purchasereturninvoice__total'], 2);?></td><td><?=$row['purchasereturninvoice__lastupdate'];?></td><td><?=$row['purchasereturninvoice__updatedby'];?></td>
