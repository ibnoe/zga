...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#compoundoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#compoundeditform').click(function(){$('#compoundeditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Compound</h3>

<p>
<div id="compoundoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/compoundedit/submit" id="compoundeditform" class="editform">
...
<td>Compound Category</td><td><?=form_input(array('name' => 'item__subcategory', 'value' => $item__subcategory, 'id' => 'item__subcategory'));?></td></tr><tr class='dimensions'>
...
<td>Expiry Date *</td><td><?=form_input(array('name' => 'item__expirydate', 'value' => $item__expirydate, 'class' => 'date', 'id' => 'item__expirydate'));?></td></tr><tr class='basic'>
