...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#manufacturing_order_in_processoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#manufacturing_order_in_processeditform').click(function(){$('#manufacturing_order_in_processeditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Manufacturing Order In Process</h3>

<p>
<div id="manufacturing_order_in_processoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_order_in_processedit/submit" id="manufacturing_order_in_processeditform" class="editform">
