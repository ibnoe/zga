...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#manufacturing_order_history_lineoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#manufacturing_order_history_lineeditform').click(function(){$('#manufacturing_order_history_lineeditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Manufacturing Order History Line</h3>

<p>
<div id="manufacturing_order_history_lineoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_order_history_lineedit/submit" id="manufacturing_order_history_lineeditform" class="editform">
