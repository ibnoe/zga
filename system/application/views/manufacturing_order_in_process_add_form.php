...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#manufacturing_order_in_processoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/manufacturing_order_in_processview/index/' },
		}; 
		
		$('#manufacturing_order_in_processform').click(function(){$('#manufacturing_order_in_processform').ajaxForm(options);});
...
<h3 class="addtitle">New Manufacturing Order In Process</h3>

<p>
<div id="manufacturing_order_in_processoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_order_in_processadd/submit" id="manufacturing_order_in_processform" class="addform">
