		...
		<form method="post" action="<?=current_url();?>" id="receive_items_for_invoicelistform" name="receive_items_for_invoicelistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td><a href="<?=base_url().'index.php/receive_items_for_invoiceview/index/'.$row['id'];?>"><img src="<?=base_url();?>resources/detail.png"></img></a></td>
					<td class='hidden'><?=$row['id'];?></td><td><?=anchor('receive_items_for_invoiceview/index/'.$row['id'], $row['receiveditem__date']);?></td><td><?=$row['receiveditem__orderid'];?></td><td><?=$row['receiveditem__suratjalanno'];?></td><td><?php if (isset($row['receiveditem__supplier_id']) && $row['supplier__firstname'] != "") echo anchor('supplierview/index/'.$row['receiveditem__supplier_id'], $row['supplier__firstname']);?></td><td><?php if (isset($row['receiveditem__warehouse_id']) && $row['warehouse__name'] != "") echo anchor('warehouseview/index/'.$row['receiveditem__warehouse_id'], $row['warehouse__name']);?></td><td><?=$row['receiveditem__lastupdate'];?></td><td><?=$row['receiveditem__updatedby'];?></td>
