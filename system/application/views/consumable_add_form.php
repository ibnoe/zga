...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#consumableoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/consumableview/index/' },
		}; 
		
		$('#consumableform').click(function(){$('#consumableform').ajaxForm(options);});
...
<h3 class="addtitle">New Consumable</h3>

<p>
<div id="consumableoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/consumableadd/submit" id="consumableform" class="addform">
