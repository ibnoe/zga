...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#sales_order_open_paymentoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#sales_order_open_paymenteditform').click(function(){$('#sales_order_open_paymenteditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Sales Order Open Payment</h3>

<p>
<div id="sales_order_open_paymentoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/sales_order_open_paymentedit/submit" id="sales_order_open_paymenteditform" class="editform">
