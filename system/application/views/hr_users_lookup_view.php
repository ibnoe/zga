		...
		<form method="post" action="<?=current_url();?>" id="hr_userslistform" name="hr_userslistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['users__firstname'];?></td><td><?=$row['users__lastname'];?></td><td><?=$row['users__username'];?></td><td><?=$row['users__lastupdate'];?></td><td><?=$row['users__updatedby'];?></td>
