		...
		<form method="post" action="<?=current_url();?>" id="permintaan_stock_chemicallistform" name="permintaan_stock_chemicallistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td><a href="<?=base_url().'index.php/permintaan_stock_chemicalview/index/'.$row['id'];?>"><img src="<?=base_url();?>resources/detail.png"></img></a></td>
					<td class='hidden'><?=$row['id'];?></td><td><?=anchor('permintaan_stock_chemicalview/index/'.$row['id'], $row['permintaanstockchemical__idstring']);?></td><td><?=$row['permintaanstockchemical__date'];?></td><td><?=$row['permintaanstockchemical__notes'];?></td><td><?=$row['permintaanstockchemical__lastupdate'];?></td><td><?=$row['permintaanstockchemical__updatedby'];?></td>
