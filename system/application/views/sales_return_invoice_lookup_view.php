		...
		<form method="post" action="<?=current_url();?>" id="sales_return_invoicelistform" name="sales_return_invoicelistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['salesreturninvoice__date'];?></td><td><?=$row['salesreturninvoice__salesreturninvoiceid'];?></td><td><?php if (isset($row['salesreturninvoice__salesreturndelivery_id']) && $row['salesreturninvoice__salesreturndelivery_id'] > 0) echo $row['salesreturndelivery__salesreturndeliveryid'];?></td><td align='right'><?=number_format($row['salesreturninvoice__total'], 2);?></td><td><?=$row['salesreturninvoice__lastupdate'];?></td><td><?=$row['salesreturninvoice__updatedby'];?></td>
