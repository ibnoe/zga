...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#manufacturing_orderoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/manufacturing_orderview/index/' },
		}; 
		
		$('#manufacturing_orderform').click(function(){$('#manufacturing_orderform').ajaxForm(options);});
...
<h3 class="addtitle">New Manufacturing Order</h3>

<p>
<div id="manufacturing_orderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_orderadd/submit" id="manufacturing_orderform" class="addform">
