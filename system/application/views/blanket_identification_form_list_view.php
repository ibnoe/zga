		...
		<form method="post" action="<?=current_url();?>" id="blanket_identification_formlistform" name="blanket_identification_formlistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td><a href="<?=base_url().'index.php/blanket_identification_formview/index/'.$row['id'];?>"><img src="<?=base_url();?>resources/detail.png"></img></a></td>
					<td class='hidden'><?=$row['id'];?></td><td><?=anchor('blanket_identification_formview/index/'.$row['id'], $row['bif__idstring']);?></td><td><?=$row['bif__date'];?></td><td><?php if (isset($row['bif__marketingofficer_id']) && $row['marketingofficer__name'] != "") echo anchor('marketing_officerview/index/'.$row['bif__marketingofficer_id'], $row['marketingofficer__name']);?></td><td><?php if (isset($row['bif__customer_id']) && $row['customer__firstname'] != "") echo anchor('customerview/index/'.$row['bif__customer_id'], $row['customer__firstname']);?></td><td><?=$row['bif__pressmodel'];?></td><td><?=$row['bif__ac'];?></td><td><?=$row['bif__ar'];?></td><td><?=$row['bif__thickness'];?></td><td><?=$row['bif__typebar1'];?></td><td><?=$row['bif__lengthbar1'];?></td><td><?=$row['bif__positionbar1'];?></td><td><?=$row['bif__typebar2'];?></td><td><?=$row['bif__lengthbar2'];?></td><td><?=$row['bif__positionbar2'];?></td><td><?=$row['bif__corner'];?></td><td><?=$row['bif__needs'];?></td><td><a href="<?=base_url().'/upload//'.$row['bif__drawingfile'];?>"> <?=$row['bif__drawingfile'];?></a></td><td><?=$row['bif__notes'];?></td><td><?=$row['bif__lastupdate'];?></td><td><?=$row['bif__updatedby'];?></td>
