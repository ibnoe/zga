		...
		<form method="post" action="<?=current_url();?>" id="company_grouplistform" name="company_grouplistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['customergroup__idstring'];?></td><td><?=$row['customergroup__name'];?></td><td><?=$row['customergroup__notes'];?></td><td><?=$row['customergroup__lastupdate'];?></td><td><?=$row['customergroup__updatedby'];?></td>
