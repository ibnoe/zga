...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#sales_return_orderoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#sales_return_ordereditform').click(function(){$('#sales_return_ordereditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Sales Return Order</h3>

<p>
<div id="sales_return_orderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/sales_return_orderedit/submit" id="sales_return_ordereditform" class="editform">
...
<td>Notes</td><td><?=form_textarea(array('name' => 'salesreturnorder__notes', 'value' => $salesreturnorder__notes, 'id' => 'salesreturnorder__notes'));?></td></tr><tr class='basic'></tr><tr class='basic'></tr><tr class='basic'></tr><tr class='basic'></tr>
