...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#karyawan_probationoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/karyawan_probationview/index/' },
		}; 
		
		$('#karyawan_probationform').click(function(){$('#karyawan_probationform').ajaxForm(options);});
...
<h3 class="addtitle">New Karyawan Probation</h3>

<p>
<div id="karyawan_probationoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/karyawan_probationadd/submit" id="karyawan_probationform" class="addform">
