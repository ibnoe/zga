...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#delivery_noteoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/delivery_noteview/index/' },
		}; 
		
		$('#delivery_noteform').click(function(){$('#delivery_noteform').ajaxForm(options);});
...
<h3 class="addtitle">New Delivery Note</h3>

<p>
<div id="delivery_noteoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/delivery_noteadd/submit" id="delivery_noteform" class="addform">
