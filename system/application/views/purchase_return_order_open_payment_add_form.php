...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#purchase_return_order_open_paymentoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/purchase_return_order_open_paymentview/index/' },
		}; 
		
		$('#purchase_return_order_open_paymentform').click(function(){$('#purchase_return_order_open_paymentform').ajaxForm(options);});
...
<h3 class="addtitle">New Purchase Return Order Open Payment</h3>

<p>
<div id="purchase_return_order_open_paymentoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/purchase_return_order_open_paymentadd/submit" id="purchase_return_order_open_paymentform" class="addform">
