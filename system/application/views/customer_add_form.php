...
<tr class='basic'>
<td>Customer ID *</td>
<td><?=form_input(array('name' => 'customer__idstring', 'value' => $customer__idstring, 'class' => 'basic', 'id' => 'customer__idstring'));?></td></tr>
<tr class='basic'>
<td>First Name *</td>
...
<tr class='basic'>
<td>Address</td>
<td><?=form_input(array('name' => 'customer__address', 'value' => $customer__address, 'class' => 'basic', 'id' => 'customer__address'));?></td></tr>
<tr class='basic'>
<td>Default Delivery Recipient</td>
<td><?=form_input(array('name' => 'customer__deliveryrecipient', 'value' => $customer__deliveryrecipient, 'class' => 'basic', 'id' => 'customer__deliveryrecipient'));?></td></tr>
<tr class='basic'>
<td>Default Delivery Address</td>
<td><?=form_input(array('name' => 'customer__deliveryaddress', 'value' => $customer__deliveryaddress, 'class' => 'basic', 'id' => 'customer__deliveryaddress'));?></td></tr>
<tr class='basic'>
<td>Default VAT(%)</td>
<td><?=form_input(array('name' => 'customer__tax_rate', 'value' => $customer__tax_rate, 'class' => 'basic', 'id' => 'customer__tax_rate'));?></td></tr>
<tr class='basic'>
<td>Default Disc(%)</td>
<td><?=form_input(array('name' => 'customer__discount', 'value' => $customer__discount, 'class' => 'basic', 'id' => 'customer__discount'));?></td></tr>
<tr class='basic'>
<td>Default Payment Term</td><script type="text/javascript">$(document).ready(function() {$('#customer__top').change(function() { $('.cash').attr('disabled', 'disabled');$('.cash').hide();$('.30_days').attr('disabled', 'disabled');$('.30_days').hide();$('.60_days').attr('disabled', 'disabled');$('.60_days').hide();var s = $("#customer__top option:selected").text();if (s == 'Cash') {$('.cash').attr('disabled', '');$('.cash').show();}if (s == '30 Days') {$('.30_days').attr('disabled', '');$('.30_days').show();}if (s == '60 Days') {$('.60_days').attr('disabled', '');$('.60_days').show();}});$('.cash').attr('disabled', 'disabled');$('.cash').hide();$('.30_days').attr('disabled', 'disabled');$('.30_days').hide();$('.60_days').attr('disabled', 'disabled');$('.60_days').hide();var s = $("#customer__top option:selected").text();if (s == 'Cash') {$('.cash').attr('disabled', '');$('.cash').show();}if (s == '30 Days') {$('.30_days').attr('disabled', '');$('.30_days').show();}if (s == '60 Days') {$('.60_days').attr('disabled', '');$('.60_days').show();}});</script>
<td><?=form_dropdown('customer__top', array('Cash' => 'Cash', '30 Days' => '30 Days', '60 Days' => '60 Days', ), $customer__top, 'id="customer__top" class="basic"');?></td></tr>
<tr class='basic'>
<td>Phone</td>
...
<tr class='basic'>
<td>Website</td>
<td><?=form_input(array('name' => 'customer__website', 'value' => $customer__website, 'class' => 'basic', 'id' => 'customer__website'));?></td></tr>
<tr class='basic'>
<td>Default Currency</td>
<td><?=form_dropdown('customer__currency_id', array(), '', 'class="basic"');?>&nbsp;<input id='customer__currency_id_lookup' type='button' value='Lookup'></input></td><div id='customer__currency_id_dialog'></div><script type="text/javascript">$(document).ready(function() {$('#customer__currency_id_dialog').dialog({ autoOpen: false, height: 500, width: 700, modal: true, buttons: { Cancel: function() { $( this ).dialog( 'close' ); } }, });$.get('<?=site_url();?>/currencylookup', function(data) { $('#customer__currency_id_dialog').html(data);$('#customer__currency_id_dialog a').attr('disabled', 'disabled');$('#customer__currency_id_dialog table tr').live('click', function() { var tr = $(this);var lines = $('td', tr).map(function(index, td) { return $(td).text(); });if (lines[0] != null) {$('select[name=customer__currency_id]').append('<option value=' + lines[0] + '>' + lines[2] + '</option>');$('select[name=customer__currency_id]').val(lines[0]);if (typeof window.customer_selected_currency_id == 'function') { customer_selected_currency_id("<?=site_url();?>"); }}$('#customer__currency_id_dialog').dialog('close');});$('#customer__currency_id_lookup').button().click(function() {$('#customer__currency_id_dialog').dialog('open');});});});</script></tr>
<tr class='basic'>
<td>Company Group</td>
<td><?=form_dropdown('customer__customergroup_id', array(), '', 'class="basic"');?>&nbsp;<input id='customer__customergroup_id_lookup' type='button' value='Lookup'></input></td><div id='customer__customergroup_id_dialog'></div><script type="text/javascript">$(document).ready(function() {$('#customer__customergroup_id_dialog').dialog({ autoOpen: false, height: 500, width: 700, modal: true, buttons: { Cancel: function() { $( this ).dialog( 'close' ); } }, });$.get('<?=site_url();?>/company_grouplookup', function(data) { $('#customer__customergroup_id_dialog').html(data);$('#customer__customergroup_id_dialog a').attr('disabled', 'disabled');$('#customer__customergroup_id_dialog table tr').live('click', function() { var tr = $(this);var lines = $('td', tr).map(function(index, td) { return $(td).text(); });if (lines[0] != null) {$('select[name=customer__customergroup_id]').append('<option value=' + lines[0] + '>' + lines[2] + '</option>');$('select[name=customer__customergroup_id]').val(lines[0]);if (typeof window.customer_selected_customergroup_id == 'function') { customer_selected_customergroup_id("<?=site_url();?>"); }}$('#customer__customergroup_id_dialog').dialog('close');});$('#customer__customergroup_id_lookup').button().click(function() {$('#customer__customergroup_id_dialog').dialog('open');});});});</script></tr>
<tr class='basic'>
<td>Marketing Officer</td>
<td><?=form_dropdown('customer__marketingofficer_id', array(), '', 'class="basic"');?>&nbsp;<input id='customer__marketingofficer_id_lookup' type='button' value='Lookup'></input></td><div id='customer__marketingofficer_id_dialog'></div><script type="text/javascript">$(document).ready(function() {$('#customer__marketingofficer_id_dialog').dialog({ autoOpen: false, height: 500, width: 700, modal: true, buttons: { Cancel: function() { $( this ).dialog( 'close' ); } }, });$.get('<?=site_url();?>/marketing_officerlookup', function(data) { $('#customer__marketingofficer_id_dialog').html(data);$('#customer__marketingofficer_id_dialog a').attr('disabled', 'disabled');$('#customer__marketingofficer_id_dialog table tr').live('click', function() { var tr = $(this);var lines = $('td', tr).map(function(index, td) { return $(td).text(); });if (lines[0] != null) {$('select[name=customer__marketingofficer_id]').append('<option value=' + lines[0] + '>' + lines[2] + '</option>');$('select[name=customer__marketingofficer_id]').val(lines[0]);if (typeof window.customer_selected_marketingofficer_id == 'function') { customer_selected_marketingofficer_id("<?=site_url();?>"); }}$('#customer__marketingofficer_id_dialog').dialog('close');});$('#customer__marketingofficer_id_lookup').button().click(function() {$('#customer__marketingofficer_id_dialog').dialog('open');});});});</script></tr>
<tr class='basic'>
<td>Status Customer</td><script type="text/javascript">$(document).ready(function() {$('#customer__status').change(function() { $('.agen').attr('disabled', 'disabled');$('.agen').hide();$('.cabang').attr('disabled', 'disabled');$('.cabang').hide();$('.dalam_kota').attr('disabled', 'disabled');$('.dalam_kota').hide();$('.luar_kota').attr('disabled', 'disabled');$('.luar_kota').hide();$('.luar_negeri').attr('disabled', 'disabled');$('.luar_negeri').hide();var s = $("#customer__status option:selected").text();if (s == 'Agen') {$('.agen').attr('disabled', '');$('.agen').show();}if (s == 'Cabang') {$('.cabang').attr('disabled', '');$('.cabang').show();}if (s == 'Dalam Kota') {$('.dalam_kota').attr('disabled', '');$('.dalam_kota').show();}if (s == 'Luar Kota') {$('.luar_kota').attr('disabled', '');$('.luar_kota').show();}if (s == 'Luar Negeri') {$('.luar_negeri').attr('disabled', '');$('.luar_negeri').show();}});$('.agen').attr('disabled', 'disabled');$('.agen').hide();$('.cabang').attr('disabled', 'disabled');$('.cabang').hide();$('.dalam_kota').attr('disabled', 'disabled');$('.dalam_kota').hide();$('.luar_kota').attr('disabled', 'disabled');$('.luar_kota').hide();$('.luar_negeri').attr('disabled', 'disabled');$('.luar_negeri').hide();var s = $("#customer__status option:selected").text();if (s == 'Agen') {$('.agen').attr('disabled', '');$('.agen').show();}if (s == 'Cabang') {$('.cabang').attr('disabled', '');$('.cabang').show();}if (s == 'Dalam Kota') {$('.dalam_kota').attr('disabled', '');$('.dalam_kota').show();}if (s == 'Luar Kota') {$('.luar_kota').attr('disabled', '');$('.luar_kota').show();}if (s == 'Luar Negeri') {$('.luar_negeri').attr('disabled', '');$('.luar_negeri').show();}});</script>
<td><?=form_dropdown('customer__status', array('Agen' => 'Agen', 'Cabang' => 'Cabang', 'Dalam Kota' => 'Dalam Kota', 'Luar Kota' => 'Luar Kota', 'Luar Negeri' => 'Luar Negeri', ), $customer__status, 'id="customer__status" class="basic"');?></td></tr>
<tr class='basic'>
<td>Company Rating</td><script type="text/javascript">$(document).ready(function() {$('#customer__rating').change(function() { $('.small').attr('disabled', 'disabled');$('.small').hide();$('.medium').attr('disabled', 'disabled');$('.medium').hide();$('.big').attr('disabled', 'disabled');$('.big').hide();var s = $("#customer__rating option:selected").text();if (s == 'Small') {$('.small').attr('disabled', '');$('.small').show();}if (s == 'Medium') {$('.medium').attr('disabled', '');$('.medium').show();}if (s == 'Big') {$('.big').attr('disabled', '');$('.big').show();}});$('.small').attr('disabled', 'disabled');$('.small').hide();$('.medium').attr('disabled', 'disabled');$('.medium').hide();$('.big').attr('disabled', 'disabled');$('.big').hide();var s = $("#customer__rating option:selected").text();if (s == 'Small') {$('.small').attr('disabled', '');$('.small').show();}if (s == 'Medium') {$('.medium').attr('disabled', '');$('.medium').show();}if (s == 'Big') {$('.big').attr('disabled', '');$('.big').show();}});</script>
<td><?=form_dropdown('customer__rating', array('Small' => 'Small', 'Medium' => 'Medium', 'Big' => 'Big', ), $customer__rating, 'id="customer__rating" class="basic"');?></td></tr>
<tr class='basic'></tr>
<tr class='basic'></tr>
<tr class='basic'></tr>
<tr class='basic'></tr>
