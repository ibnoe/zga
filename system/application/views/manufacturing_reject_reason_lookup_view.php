		...
		<form method="post" action="<?=current_url();?>" id="manufacturing_reject_reasonlistform" name="manufacturing_reject_reasonlistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['manufacturingrejectreason__name'];?></td><td><?=$row['manufacturingrejectreason__name'];?></td><td><?=$row['manufacturingrejectreason__lastupdate'];?></td><td><?=$row['manufacturingrejectreason__updatedby'];?></td>
