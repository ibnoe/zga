...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#penerimaan_item_for_service_lineoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#penerimaan_item_for_service_lineeditform').click(function(){$('#penerimaan_item_for_service_lineeditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Penerimaan Item For Service Line</h3>

<p>
<div id="penerimaan_item_for_service_lineoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/penerimaan_item_for_service_lineedit/submit" id="penerimaan_item_for_service_lineeditform" class="editform">
