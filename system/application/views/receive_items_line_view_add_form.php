...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#receive_items_line_viewoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		}; 
		
		$('#receive_items_line_viewform').click(function(){$('#receive_items_line_viewform').ajaxForm(options);});
