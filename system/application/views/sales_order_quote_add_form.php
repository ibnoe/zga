...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#sales_order_quoteoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/sales_order_quoteview/index/' },
		}; 
		
		$('#sales_order_quoteform').click(function(){$('#sales_order_quoteform').ajaxForm(options);});
...
<h3 class="addtitle">New Sales Order Quote</h3>

<p>
<div id="sales_order_quoteoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/sales_order_quoteadd/submit" id="sales_order_quoteform" class="addform">
