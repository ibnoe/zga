		...
		<form method="post" action="<?=current_url();?>" id="to_warehouselistform" name="to_warehouselistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td><a href="<?=base_url().'index.php/to_warehouseview/index/'.$row['id'];?>"><img src="<?=base_url();?>resources/detail.png"></img></a></td>
					<td class='hidden'><?=$row['id'];?></td><td><?=anchor('to_warehouseview/index/'.$row['id'], $row['warehouse__name']);?></td><td><?=$row['warehouse__address'];?></td><td><?=$row['warehouse__phone'];?></td><td><?=$row['warehouse__fax'];?></td><td><?=$row['warehouse__lastupdate'];?></td><td><?=$row['warehouse__updatedby'];?></td>
