		...
		<form method="post" action="<?=current_url();?>" id="compoundlistform" name="compoundlistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['item__idstring'];?></td><td><?=$row['item__name'];?></td><td><?=$row['item__subcategory'];?></td><td align='right'><?=number_format($row['item__expiryduration'], 2);?></td><td><?=$row['item__expirydate'];?></td><td align='right'><?=number_format($row['item__minquantity'], 2);?></td><td align='right'><?=number_format($row['item__maxquantity'], 2);?></td><td align='right'><?=number_format($row['item__buffer3months'], 2);?></td><td><?php if (isset($row['item__persediaan_coa_id']) && $row['item__persediaan_coa_id'] > 0) echo $row['coa__name'];?></td><td><?php if (isset($row['item__hpp_coa_id']) && $row['item__hpp_coa_id'] > 0) echo $row['coa1__name'];?></td><td><?php if (isset($row['item__itemcategory_id']) && $row['item__itemcategory_id'] > 0) echo $row['itemcategory__name'];?></td><td><?=$row['item__lastupdate'];?></td><td><?=$row['item__updatedby'];?></td>
