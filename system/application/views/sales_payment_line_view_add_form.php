...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#sales_payment_line_viewoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/sales_payment_line_viewview/index/' },
		}; 
		
		$('#sales_payment_line_viewform').click(function(){$('#sales_payment_line_viewform').ajaxForm(options);});
