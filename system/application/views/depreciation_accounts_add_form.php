...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#depreciation_accountsoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/depreciation_accountsview/index/' },
		}; 
		
		$('#depreciation_accountsform').click(function(){$('#depreciation_accountsform').ajaxForm(options);});
...
<h3 class="addtitle">New Depreciation Accounts</h3>

<p>
<div id="depreciation_accountsoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/depreciation_accountsadd/submit" id="depreciation_accountsform" class="addform">
