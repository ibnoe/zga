...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#supplieroutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/supplierview/index/' },
		}; 
		
		$('#supplierform').click(function(){$('#supplierform').ajaxForm(options);});
...
<h3 class="addtitle">New Supplier</h3>

<p>
<div id="supplieroutput"></div>
</p>

<form method="post" action="<?=site_url();?>/supplieradd/submit" id="supplierform" class="addform">
