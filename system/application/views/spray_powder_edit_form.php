...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#spray_powderoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#spray_powdereditform').click(function(){$('#spray_powdereditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Spray Powder</h3>

<p>
<div id="spray_powderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/spray_powderedit/submit" id="spray_powdereditform" class="editform">

<?=form_hidden("spray_powder_id", $spray_powder_id);?>
...
<td>Chemical Code</td><td><?=form_input(array('name' => 'item__chemicalcode', 'value' => $item__chemicalcode, 'id' => 'item__chemicalcode'));?></td></tr><tr class='basic'>
<td>Weight</td><td><?=form_input(array('name' => 'item__weight', 'value' => $item__weight, 'id' => 'item__weight'));?></td></tr><tr class='basic'>
