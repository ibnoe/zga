...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#pay_accountsoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/pay_accountsview/index/' },
		}; 
		
		$('#pay_accountsform').click(function(){$('#pay_accountsform').ajaxForm(options);});
...
<h3 class="addtitle">New Pay Accounts</h3>

<p>
<div id="pay_accountsoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/pay_accountsadd/submit" id="pay_accountsform" class="addform">
