...
<td><?=form_dropdown('purchaseinvoice__ongkoskirimimport_id', array(), '', 'class="basic"');?>&nbsp;<input id='purchaseinvoice__ongkoskirimimport_id_lookup' type='button' value='Lookup'></input></td><div id='purchaseinvoice__ongkoskirimimport_id_dialog'></div><script type="text/javascript">$(document).ready(function() {$('#purchaseinvoice__ongkoskirimimport_id_dialog').dialog({ autoOpen: false, height: 500, width: 700, modal: true, buttons: { Cancel: function() { $( this ).dialog( 'close' ); } }, });$.get('<?=site_url();?>/ongkos_kirim_importlookup', function(data) { $('#purchaseinvoice__ongkoskirimimport_id_dialog').html(data);$('#purchaseinvoice__ongkoskirimimport_id_dialog a').attr('disabled', 'disabled');$('#purchaseinvoice__ongkoskirimimport_id_dialog table tr').live('click', function() { var tr = $(this);var lines = $('td', tr).map(function(index, td) { return $(td).text(); });if (lines[0] != null) {$('select[name=purchaseinvoice__ongkoskirimimport_id]').append('<option value=' + lines[0] + '>' + lines[1] + '</option>');$('select[name=purchaseinvoice__ongkoskirimimport_id]').val(lines[0]);if (typeof window.purchase_invoice_selected_ongkoskirimimport_id == 'function') { purchase_invoice_selected_ongkoskirimimport_id("<?=site_url();?>"); }}$('#purchaseinvoice__ongkoskirimimport_id_dialog').dialog('close');});$('#purchaseinvoice__ongkoskirimimport_id_lookup').button().click(function() {$('#purchaseinvoice__ongkoskirimimport_id_dialog').dialog('open');});});});</script></tr>
<tr class='basic'></tr>
<tr class='basic'></tr>
<tr class='basic'></tr>
<tr class='basic'></tr>
