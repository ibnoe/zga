...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#repackingoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/repackingview/index/' },
		}; 
		
		$('#repackingform').click(function(){$('#repackingform').ajaxForm(options);});
...
<h3 class="addtitle">New Repacking</h3>

<p>
<div id="repackingoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/repackingadd/submit" id="repackingform" class="addform">
