...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#manufacturing_order_history_lineoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/manufacturing_order_history_lineview/index/' },
		}; 
		
		$('#manufacturing_order_history_lineform').click(function(){$('#manufacturing_order_history_lineform').ajaxForm(options);});
...
<h3 class="addtitle">New Manufacturing Order History Line</h3>

<p>
<div id="manufacturing_order_history_lineoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_order_history_lineadd/submit" id="manufacturing_order_history_lineform" class="addform">
