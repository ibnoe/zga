...
<table class="trialbalance" cellpadding="0" cellspacing="0">
	...
	<?php foreach($customers as $customer): ?>
		<tr>
				<td><?=$customer['idstring'];?></td>
					<?php foreach($currencies as $currency): ?>
						<td class="balance">
							<?=number_format($top1w[$customer['idstring']][$currency['name']],0);?>
							<?php $balance['top1w'][$currency['name']] += $top1w[$customer['idstring']][$currency['name']]; ?>
							<?php $totalbalance[$currency['name']] += $top1w[$customer['idstring']][$currency['name']]; ?>
						</td>
						<td class="balance">
							<?=number_format($top2w[$customer['idstring']][$currency['name']],0);?>	
							<?php $balance['top2w'][$currency['name']] += $top2w[$customer['idstring']][$currency['name']]; ?>
							<?php $totalbalance[$currency['name']] += $top2w[$customer['idstring']][$currency['name']]; ?>
						</td>
						<td class="balance">
							<?=number_format($top1m[$customer['idstring']][$currency['name']],0);?>	
							<?php $balance['top1m'][$currency['name']] += $top1m[$customer['idstring']][$currency['name']]; ?>
							<?php $totalbalance[$currency['name']] += $top1m[$customer['idstring']][$currency['name']]; ?>
						</td>
						<td class="balance">
							<?=number_format($top2m[$customer['idstring']][$currency['name']],0);?>	
							<?php $balance['top2m'][$currency['name']] += $top2m[$customer['idstring']][$currency['name']]; ?>
							<?php $totalbalance[$currency['name']] += $top2m[$customer['idstring']][$currency['name']]; ?>
						</td>
					<?php endforeach; ?>
		</tr>
	<?php endforeach; ?>
