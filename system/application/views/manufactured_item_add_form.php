...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#manufactured_itemoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/manufactured_itemview/index/' },
		}; 
		
		$('#manufactured_itemform').click(function(){$('#manufactured_itemform').ajaxForm(options);});
...
<h3 class="addtitle">New Manufactured Item</h3>

<p>
<div id="manufactured_itemoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufactured_itemadd/submit" id="manufactured_itemform" class="addform">
