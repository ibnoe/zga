...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#sales_orderoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#sales_ordereditform').click(function(){$('#sales_ordereditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Sales Order</h3>

<p>
<div id="sales_orderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/sales_orderedit/submit" id="sales_ordereditform" class="editform">
