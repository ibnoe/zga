...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#insert_item_lineoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		}; 
		
		$('#insert_item_lineform').click(function(){$('#insert_item_lineform').ajaxForm(options);});
...
<h3 class="addtitle">New Insert Item Line</h3>

<p>
<div id="insert_item_lineoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/insert_item_lineadd/submit" id="insert_item_lineform" class="addform">
