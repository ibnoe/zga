...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#manufacturing_order_historyoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/manufacturing_order_historyview/index/' },
		}; 
		
		$('#manufacturing_order_historyform').click(function(){$('#manufacturing_order_historyform').ajaxForm(options);});
...
<h3 class="addtitle">New Manufacturing Order History</h3>

<p>
<div id="manufacturing_order_historyoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_order_historyadd/submit" id="manufacturing_order_historyform" class="addform">
