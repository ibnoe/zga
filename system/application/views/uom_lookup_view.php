		...
		<form method="post" action="<?=current_url();?>" id="uomlistform" name="uomlistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['uom__name'];?></td><td align='right'><?=number_format($row['uom__multiplier'], 2);?></td><td><?=$row['uom__lastupdate'];?></td><td><?=$row['uom__updatedby'];?></td>
