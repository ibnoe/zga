		...
		<form method="post" action="<?=current_url();?>" id="sales_return_delivery_for_invoicelistform" name="sales_return_delivery_for_invoicelistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['salesreturndelivery__date'];?></td><td><?=$row['salesreturndelivery__salesreturndeliveryid'];?></td><td><?php if (isset($row['salesreturndelivery__customer_id']) && $row['salesreturndelivery__customer_id'] > 0) echo $row['customer__firstname'];?></td><td><?php if (isset($row['salesreturndelivery__warehouse_id']) && $row['salesreturndelivery__warehouse_id'] > 0) echo $row['warehouse__name'];?></td><td><?=$row['salesreturndelivery__notes'];?></td><td><?=$row['salesreturndelivery__lastupdate'];?></td><td><?=$row['salesreturndelivery__updatedby'];?></td>
