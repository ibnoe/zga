...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#manufacturing_order_waiting_listoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/manufacturing_order_waiting_listview/index/' },
		}; 
		
		$('#manufacturing_order_waiting_listform').click(function(){$('#manufacturing_order_waiting_listform').ajaxForm(options);});
...
<h3 class="addtitle">New Manufacturing Order Waiting List</h3>

<p>
<div id="manufacturing_order_waiting_listoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_order_waiting_listadd/submit" id="manufacturing_order_waiting_listform" class="addform">
...
<td><?=form_input(array('name' => 'manufacturingorder__quantitytoprocess', 'value' => $manufacturingorder__quantitytoprocess, 'class' => 'basic', 'id' => 'manufacturingorder__quantitytoprocess'));?></td></tr>
<tr class='basic'>
<td>Unit *</td>
