...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#cogs_accountsoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/cogs_accountsview/index/' },
		}; 
		
		$('#cogs_accountsform').click(function(){$('#cogs_accountsform').ajaxForm(options);});
...
<h3 class="addtitle">New COGS Accounts</h3>

<p>
<div id="cogs_accountsoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/cogs_accountsadd/submit" id="cogs_accountsform" class="addform">
