...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#compoundoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/compoundview/index/' },
		}; 
		
		$('#compoundform').click(function(){$('#compoundform').ajaxForm(options);});
...
<h3 class="addtitle">New Compound</h3>

<p>
<div id="compoundoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/compoundadd/submit" id="compoundform" class="addform">
...
<td><?=form_input(array('name' => 'item__expiryduration', 'value' => $item__expiryduration, 'class' => 'dimensions', 'id' => 'item__expiryduration'));?></td></tr>
<tr class='dimensions'>
<td>Expiry Date *</td><script type="text/javascript">$(document).ready(function() {$(".item__expirydatedimensions").datepicker({ showOn: 'button', buttonText: "Cal", autoSize: true, dateFormat: 'dd-mm-yy' });});</script>
<td><?=form_input(array('name' => 'item__expirydate', 'value' => $item__expirydate, 'class' => 'item__expirydatedimensions'));?></td></tr>
<tr class='basic'>
