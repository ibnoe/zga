...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#blanketoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/blanketview/index/' },
		}; 
		
		$('#blanketform').click(function(){$('#blanketform').ajaxForm(options);});
...
<h3 class="addtitle">New Blanket</h3>

<p>
<div id="blanketoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/blanketadd/submit" id="blanketform" class="addform">
...
<tr class='basic'>
<td>Pallete No</td>
<td><?=form_input(array('name' => 'item__palleteno', 'value' => $item__palleteno, 'class' => 'basic', 'id' => 'item__palleteno'));?></td></tr>
<tr class='basic'>
<td>Code Baru</td>
<td><?=form_input(array('name' => 'item__codebaru', 'value' => $item__codebaru, 'class' => 'basic', 'id' => 'item__codebaru'));?></td></tr>
<tr class='basic'>
<td>Press & Type</td>
<td><?=form_input(array('name' => 'item__pressntype', 'value' => $item__pressntype, 'class' => 'basic', 'id' => 'item__pressntype'));?></td></tr>
<tr class='dimensions'>
<td>AC</td>
...
<tr class='basic'>
<td>Bar Type</td>
<td><?=form_input(array('name' => 'item__bartype', 'value' => $item__bartype, 'class' => 'basic', 'id' => 'item__bartype'));?></td></tr>
<tr class='basic'>
<td>Moving Speed</td>
<td><?=form_input(array('name' => 'item__movingspeed', 'value' => $item__movingspeed, 'class' => 'basic', 'id' => 'item__movingspeed'));?></td></tr>
<tr class='basic'>
<td>Minimum Stock</td>
...
<tr class='basic'>
<td>Converting Place</td>
<td><?=form_input(array('name' => 'item__barorigin', 'value' => $item__barorigin, 'class' => 'basic', 'id' => 'item__barorigin'));?></td></tr>
<tr class='basic'>
<td>Bar/Non Bar</td>
<td><input type='checkbox' name='item__barnonbar' value='1'></input></td></tr>
<tr class='basic'>
