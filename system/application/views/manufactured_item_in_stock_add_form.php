...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#manufactured_item_in_stockoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/manufactured_item_in_stockview/index/' },
		}; 
		
		$('#manufactured_item_in_stockform').click(function(){$('#manufactured_item_in_stockform').ajaxForm(options);});
...
<h3 class="addtitle">New Manufactured Item In Stock</h3>

<p>
<div id="manufactured_item_in_stockoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufactured_item_in_stockadd/submit" id="manufactured_item_in_stockform" class="addform">
