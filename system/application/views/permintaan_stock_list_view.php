		...
		<form method="post" action="<?=current_url();?>" id="permintaan_stocklistform" name="permintaan_stocklistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td><a href="<?=base_url().'index.php/permintaan_stockview/index/'.$row['id'];?>"><img src="<?=base_url();?>resources/detail.png"></img></a></td>
					<td class='hidden'><?=$row['id'];?></td><td><?=anchor('permintaan_stockview/index/'.$row['id'], $row['permintaanstock__idstring']);?></td><td><?=$row['permintaanstock__date'];?></td><td><?=$row['permintaanstock__notes'];?></td><td><?=$row['permintaanstock__lastupdate'];?></td><td><?=$row['permintaanstock__updatedby'];?></td>
