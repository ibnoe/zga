...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#to_warehouseoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/to_warehouseview/index/' },
		}; 
		
		$('#to_warehouseform').click(function(){$('#to_warehouseform').ajaxForm(options);});
...
<h3 class="addtitle">New To Warehouse</h3>

<p>
<div id="to_warehouseoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/to_warehouseadd/submit" id="to_warehouseform" class="addform">
