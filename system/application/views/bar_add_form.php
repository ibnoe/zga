...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#baroutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/barview/index/' },
		}; 
		
		$('#barform').click(function(){$('#barform').ajaxForm(options);});
...
<h3 class="addtitle">New Bar</h3>

<p>
<div id="baroutput"></div>
</p>

<form method="post" action="<?=site_url();?>/baradd/submit" id="barform" class="addform">
...
<tr class='basic'>
<td>Bar Code</td>
<td><?=form_input(array('name' => 'item__barcode', 'value' => $item__barcode, 'class' => 'basic', 'id' => 'item__barcode'));?></td></tr>
<tr class='basic'>
<td>Length</td>
<td><?=form_input(array('name' => 'item__length', 'value' => $item__length, 'class' => 'basic', 'id' => 'item__length'));?></td></tr>
<tr class='basic'>
<td>Press Type</td>
<td><?=form_input(array('name' => 'item__pressmodel', 'value' => $item__pressmodel, 'class' => 'basic', 'id' => 'item__pressmodel'));?></td></tr>
<tr class='basic'>
