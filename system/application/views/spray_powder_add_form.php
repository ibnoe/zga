...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#spray_powderoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/spray_powderview/index/' },
		}; 
		
		$('#spray_powderform').click(function(){$('#spray_powderform').ajaxForm(options);});
...
<h3 class="addtitle">New Spray Powder</h3>

<p>
<div id="spray_powderoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/spray_powderadd/submit" id="spray_powderform" class="addform">
