		...
		<form method="post" action="<?=current_url();?>" id="purchase_return_delivery_for_invoicelistform" name="purchase_return_delivery_for_invoicelistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['purchasereturndelivery__date'];?></td><td><?=$row['purchasereturndelivery__purchasereturndeliveryid'];?></td><td><?php if (isset($row['purchasereturndelivery__supplier_id']) && $row['purchasereturndelivery__supplier_id'] > 0) echo $row['supplier__firstname'];?></td><td><?php if (isset($row['purchasereturndelivery__warehouse_id']) && $row['purchasereturndelivery__warehouse_id'] > 0) echo $row['warehouse__name'];?></td><td><?=$row['purchasereturndelivery__notes'];?></td><td><?=$row['purchasereturndelivery__lastupdate'];?></td><td><?=$row['purchasereturndelivery__updatedby'];?></td>
