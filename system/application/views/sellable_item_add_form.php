...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#sellable_itemoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/sellable_itemview/index/' },
		}; 
		
		$('#sellable_itemform').click(function(){$('#sellable_itemform').ajaxForm(options);});
...
<h3 class="addtitle">New Sellable Item</h3>

<p>
<div id="sellable_itemoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/sellable_itemadd/submit" id="sellable_itemform" class="addform">
