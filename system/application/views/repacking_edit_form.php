...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#repackingoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#repackingeditform').click(function(){$('#repackingeditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Repacking</h3>

<p>
<div id="repackingoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/repackingedit/submit" id="repackingeditform" class="editform">
