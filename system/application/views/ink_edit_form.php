...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#inkoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#inkeditform').click(function(){$('#inkeditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Ink</h3>

<p>
<div id="inkoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/inkedit/submit" id="inkeditform" class="editform">
...
<td>Ink Code</td><td><?=form_input(array('name' => 'item__inkcode', 'value' => $item__inkcode, 'id' => 'item__inkcode'));?></td></tr><tr class='basic'>
