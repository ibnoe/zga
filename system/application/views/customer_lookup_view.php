		...
		<form method="post" action="<?=current_url();?>" id="customerlistform" name="customerlistform" class="listform">
			...
			<table class="main">
				...
				<?php foreach ($rows as $row): ?>
					...
					<td class='hidden'><?=$row['id'];?></td><td><?=$row['customer__idstring'];?></td><td><?=$row['customer__firstname'];?></td><td><?=$row['customer__lastname'];?></td><td><?=$row['customer__address'];?></td><td><?=$row['customer__deliveryrecipient'];?></td><td><?=$row['customer__deliveryaddress'];?></td><td align='right'><?=number_format($row['customer__tax_rate'], 2);?></td><td align='right'><?=number_format($row['customer__discount'], 2);?></td><td><?=$row['customer__top'];?></td><td><?=$row['customer__phone'];?></td><td><?=$row['customer__fax'];?></td><td><?=$row['customer__npwp'];?></td><td><?=$row['customer__email'];?></td><td><?=$row['customer__website'];?></td><td><?php if (isset($row['customer__currency_id']) && $row['customer__currency_id'] > 0) echo $row['currency__name'];?></td><td><?php if (isset($row['customer__customergroup_id']) && $row['customer__customergroup_id'] > 0) echo $row['customergroup__name'];?></td><td><?php if (isset($row['customer__marketingofficer_id']) && $row['customer__marketingofficer_id'] > 0) echo $row['marketingofficer__name'];?></td><td><?=$row['customer__status'];?></td><td><?=$row['customer__rating'];?></td><td><?=$row['customer__lastupdate'];?></td><td><?=$row['customer__updatedby'];?></td>
