...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#core_repairoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#core_repaireditform').click(function(){$('#core_repaireditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Core Repair</h3>

<p>
<div id="core_repairoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/core_repairedit/submit" id="core_repaireditform" class="editform">
