...
<script type="text/javascript">
  $(document).ready(function() {
    var options = { 
			target:        '#purchase_order_open_receivedoutput',
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=site_url();?>/purchase_order_open_receivedview/index/' },
		}; 
		
		$('#purchase_order_open_receivedform').click(function(){$('#purchase_order_open_receivedform').ajaxForm(options);});
...
<h3 class="addtitle">New Purchase Order Open Received</h3>

<p>
<div id="purchase_order_open_receivedoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/purchase_order_open_receivedadd/submit" id="purchase_order_open_receivedform" class="addform">
