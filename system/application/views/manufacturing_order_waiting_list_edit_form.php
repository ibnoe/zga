...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var options = {
			target:        '#manufacturing_order_waiting_listoutput',   // target element(s) to be updated with server response 
			success: 		function(data) { if (data.indexOf('success') != -1) location.href='<?=$_SERVER['HTTP_REFERER'];?>' },
		};
			 
		$('#manufacturing_order_waiting_listeditform').click(function(){$('#manufacturing_order_waiting_listeditform').ajaxForm(options);});
	});
</script>

<div id="maincontent">

<h3 class="edittitle">Edit Manufacturing Order Waiting List</h3>

<p>
<div id="manufacturing_order_waiting_listoutput"></div>
</p>

<form method="post" action="<?=site_url();?>/manufacturing_order_waiting_listedit/submit" id="manufacturing_order_waiting_listeditform" class="editform">
