...
class pay_accountsadd extends Controller {
...
$data['coa__idstring'] = $this->generallib->genId('Pay Accounts');
$data['coa__name'] = '';
$coatype_opt = array();
$coatype_opt[''] = 'None';
...
$data['coa__createdby'] = '';
		...
		$this->load->view('pay_accounts_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('pay_accountsadd','coa','aftersave', $coa_id);
