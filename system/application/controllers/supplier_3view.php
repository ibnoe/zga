...
class supplier_3view extends Controller {

	function supplier_3view()
	{
		parent::Controller();	
...
$this->db->where('id', $supplier_3_id);
$this->db->select('*');
...
$this->load->view('supplier_3_view_form', $data);
}
...
$this->db->where('id', $data['supplier_3_id']);
