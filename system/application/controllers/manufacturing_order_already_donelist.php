...
class manufacturing_order_already_donelist extends Controller {

	function manufacturing_order_already_donelist()
	{
		parent::Controller();	
...
$this->db->order_by('manufacturingorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('manufacturing_order_already_done_list_view', $data);
	}
}
