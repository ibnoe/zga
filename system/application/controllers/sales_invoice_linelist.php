...
class sales_invoice_linelist extends Controller {

	function sales_invoice_linelist()
	{
		parent::Controller();	
...
$this->db->order_by('salesinvoiceline__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		$data['fields'] = array('item__name' => 'Item', 'salesinvoiceline__quantity' => 'Quantity', 'uom__name' => 'Unit', 'salesinvoiceline__price' => 'Price', 'salesinvoiceline__subtotal' => 'SubTotal', 'salesinvoiceline__lastupdate' => 'Last Update', 'salesinvoiceline__updatedby' => 'Last Update By');
		...
		///
		$this->load->view('sales_invoice_line_list_view', $data);
	}
}
