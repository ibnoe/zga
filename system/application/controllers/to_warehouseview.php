...
class to_warehouseview extends Controller {

	function to_warehouseview()
	{
		parent::Controller();	
...
$this->db->where('id', $to_warehouse_id);
$this->db->select('*');
...
$this->load->view('to_warehouse_view_form', $data);
}
...
$this->db->where('id', $data['to_warehouse_id']);
