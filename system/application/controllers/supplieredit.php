...
$q = $this->db->where('id', $supplier_id);
$this->db->select('*');
...
$this->load->view('supplier_edit_form', $data);
}
...
if (isset($_POST['supplier__idstring'])) {$this->db->where("id !=", $_POST['supplier_id']);
...
$this->db->where('id', $_POST['supplier_id']);
$this->db->update('supplier', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('supplieredit','supplier','afteredit', $_POST['supplier_id']);
