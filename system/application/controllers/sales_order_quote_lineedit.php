...
class sales_order_quote_lineedit extends Controller {

	function sales_order_quote_lineedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $sales_order_quote_line_id);
$this->db->select('*');
...
$this->load->view('sales_order_quote_line_edit_form', $data);
}
...
$data['item_id'] = $_POST['salesorderline__item_id'];if (isset($_POST['salesorderline__quantity']))
...
$this->db->where('id', $_POST['sales_order_quote_line_id']);
$this->db->update('salesorderline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('sales_order_quote_lineedit','salesorderline','afteredit', $_POST['sales_order_quote_line_id']);
