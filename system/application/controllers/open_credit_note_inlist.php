...
class open_credit_note_inlist extends Controller {

	function open_credit_note_inlist()
	{
		parent::Controller();	
...
$this->db->where('creditnotein.usedflag = 0');
...
$this->db->select('creditnotein.id as creditnotein__id', false);
...
$this->db->select('creditnotein.updatedby as creditnotein__updatedby', false);
		...
		if (isset($_POST['searchtext']) && $_POST['searchtext'] != "")
		{
			...
			$where .= "creditnotein.id like '%".$_POST['searchtext']."%'";$where .= " || creditnotein.creditnoteinid like '%".$_POST['searchtext']."%'";$where .= " || creditnotein.date like '%".$_POST['searchtext']."%'";$where .= " || creditnotein.expirydate like '%".$_POST['searchtext']."%'";$where .= " || supplier.firstname like '%".$_POST['searchtext']."%'";$where .= " || coa.name like '%".$_POST['searchtext']."%'";$where .= " || currency.name like '%".$_POST['searchtext']."%'";$where .= " || creditnotein.amount like '%".$_POST['searchtext']."%'";$where .= " || creditnotein.amountused like '%".$_POST['searchtext']."%'";$where .= " || creditnotein.notes like '%".$_POST['searchtext']."%'";$where .= " || creditnotein.usedflag like '%".$_POST['searchtext']."%'";$where .= " || creditnotein.lastupdate like '%".$_POST['searchtext']."%'";$where .= " || creditnotein.updatedby like '%".$_POST['searchtext']."%'";
...
$this->db->order_by('creditnotein__id', 'asc');
...
$this->db->order_by('creditnotein__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('open_credit_note_in_list_view', $data);
	}
}
