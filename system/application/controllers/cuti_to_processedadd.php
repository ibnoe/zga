...
class cuti_to_processedadd extends Controller {
...
$data['cutiklaim__createdby'] = '';
		...
		$this->load->view('cuti_to_processed_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('cuti_to_processedadd','cutiklaim','aftersave', $cutiklaim_id);
