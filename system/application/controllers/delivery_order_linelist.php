...
class delivery_order_linelist extends Controller {

	function delivery_order_linelist()
	{
		parent::Controller();	
...
$this->db->order_by('deliveryorderline__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		$data['fields'] = array('item__name' => 'Item', 'deliveryorderline__quantitytosend' => 'Quantity', 'uom__name' => 'Unit', 'deliveryorderline__lastupdate' => 'Last Update', 'deliveryorderline__updatedby' => 'Last Update By');
		...
		///
		$this->load->view('delivery_order_line_list_view', $data);
	}
}
