...
class giro_in_for_flagginglist extends Controller {

	function giro_in_for_flagginglist()
	{
		parent::Controller();	
...
$this->db->where('giroin.usedflag = 0');
...
$this->db->order_by('giroin__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('giro_in_for_flagging_list_view', $data);
	}
}
