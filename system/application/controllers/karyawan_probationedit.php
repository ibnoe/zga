...
class karyawan_probationedit extends Controller {

	function karyawan_probationedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $karyawan_probation_id);
$this->db->select('*');
...
$this->load->view('karyawan_probation_edit_form', $data);
}
...
if (isset($_POST['karyawan__idstring'])) {$this->db->where("id !=", $_POST['karyawan_probation_id']);
...
$this->db->where('id', $_POST['karyawan_probation_id']);
$this->db->update('karyawan', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('karyawan_probationedit','karyawan','afteredit', $_POST['karyawan_probation_id']);
