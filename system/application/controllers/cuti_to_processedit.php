...
class cuti_to_processedit extends Controller {

	function cuti_to_processedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $cuti_to_process_id);
$this->db->select('*');
...
$this->load->view('cuti_to_process_edit_form', $data);
}
...
$this->db->where('id', $_POST['cuti_to_process_id']);
$this->db->update('cutiklaim', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('cuti_to_processedit','cutiklaim','afteredit', $_POST['cuti_to_process_id']);
