...
class purchase_invoice_lineadd extends Controller {
...
$data['purchaseinvoiceline__createdby'] = '';
		...
		$this->load->view('purchase_invoice_line_add_form', $data);
	}
...
$this->generallib->commonfunction('purchase_invoice_lineadd','purchaseinvoiceline','aftersave', $purchaseinvoiceline_id);
...
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('purchase_invoice_lineadd','purchaseinvoiceline','validation', 0, $valdata);
