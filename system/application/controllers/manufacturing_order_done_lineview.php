...
class manufacturing_order_done_lineview extends Controller {

	function manufacturing_order_done_lineview()
	{
		parent::Controller();	
...
$this->db->where('id', $manufacturing_order_done_line_id);
$this->db->select('*');
...
$this->load->view('manufacturing_order_done_line_view_form', $data);
}
...
$this->db->where('id', $data['manufacturing_order_done_line_id']);
