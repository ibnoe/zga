...
class purchase_return_payment_lineedit extends Controller {

	function purchase_return_payment_lineedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $purchase_return_payment_line_id);
$this->db->select('*');
...
$this->load->view('purchase_return_payment_line_edit_form', $data);
}
...
$this->db->where('id', $_POST['purchase_return_payment_line_id']);
$this->db->update('purchasereturnpaymentline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('purchase_return_payment_lineedit','purchasereturnpaymentline','afteredit', $_POST['purchase_return_payment_line_id']);
