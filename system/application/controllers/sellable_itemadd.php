...
class sellable_itemadd extends Controller {
...
$data['item__idstring'] = $this->generallib->genId('Sellable Item');
$data['item__name'] = '';
...
$data['item__createdby'] = '';
		...
		$this->load->view('sellable_item_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('sellable_itemadd','item','aftersave', $item_id);
