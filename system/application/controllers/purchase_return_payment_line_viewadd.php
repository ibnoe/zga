...
class purchase_return_payment_line_viewadd extends Controller {
...
$data['purchasereturnpaymentline__createdby'] = '';
		...
		$this->load->view('purchase_return_payment_line_view_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('purchase_return_payment_line_viewadd','purchasereturnpaymentline','aftersave', $purchasereturnpaymentline_id);
