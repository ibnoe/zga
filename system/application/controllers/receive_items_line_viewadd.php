...
class receive_items_line_viewadd extends Controller {
...
$data['receiveditemline__createdby'] = '';
		...
		$this->load->view('receive_items_line_view_add_form', $data);
	}
...
$data = array();
$data['receiveditem_id'] = $_POST['receiveditem_id'];if (isset($_POST['receiveditemline__item_id']))
...
$error .= $this->generallib->commonfunction('receive_items_line_viewadd','receiveditemline','aftersave', $receiveditemline_id);
