...
class giro_out_clearance_lineadd extends Controller {
...
$data['girooutclearanceline__createdby'] = '';
		...
		$this->load->view('giro_out_clearance_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('giro_out_clearance_lineadd','girooutclearanceline','aftersave', $girooutclearanceline_id);
