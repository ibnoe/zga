...
class sales_orderadd extends Controller {
...
$data['salesorder__orderid'] = $this->generallib->genId('Sales Order');
...
$data['salesorder__status'] = 'Approved';
$data['salesorder__modulename'] = 'sales_order';
...
$data['salesorder__createdby'] = '';
		...
		$this->load->view('sales_order_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('sales_orderadd','salesorder','aftersave', $salesorder_id);
