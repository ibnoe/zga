...
class purchase_return_delivery_line_viewlist extends Controller {

	function purchase_return_delivery_line_viewlist()
	{
		parent::Controller();	
	...
	function _qhelp($data, $purchasereturndelivery_id)
	{
		
$this->db->where('purchasereturndeliveryline.purchasereturndelivery_id', $purchasereturndelivery_id);$this->db->from('purchasereturndeliveryline');
...
$this->db->order_by('purchasereturndeliveryline__lastupdate', 'desc');
	...
	function index($purchasereturndelivery_id=0)
	{
		$data = array();
		...
		$data['foreign_id'] = $purchasereturndelivery_id;$data['fields'] = array('item__name' => 'Item', 'purchasereturndeliveryline__quantitytosend' => 'Quantity', 'uom__name' => 'Unit', 'purchasereturndeliveryline__lastupdate' => 'Last Update', 'purchasereturndeliveryline__updatedby' => 'Last Update By');
		...
		$data = $this->_qhelp($data, $purchasereturndelivery_id);
		...
		///
		$this->load->view('purchase_return_delivery_line_view_list_view', $data);
	}
}
