...
class purchase_return_delivery_for_invoiceedit extends Controller {

	function purchase_return_delivery_for_invoiceedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $purchase_return_delivery_for_invoice_id);
$this->db->select('*');
...
$this->load->view('purchase_return_delivery_for_invoice_edit_form', $data);
}
...
$this->db->where('id', $_POST['purchase_return_delivery_for_invoice_id']);
$this->db->update('purchasereturndelivery', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('purchase_return_delivery_for_invoiceedit','purchasereturndelivery','afteredit', $_POST['purchase_return_delivery_for_invoice_id']);
