...
class reject_manufacturing_lineadd extends Controller {
...
$data['rejectmanufacturingline__createdby'] = '';
		...
		$this->load->view('reject_manufacturing_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('reject_manufacturing_lineadd','rejectmanufacturingline','aftersave', $rejectmanufacturingline_id);
