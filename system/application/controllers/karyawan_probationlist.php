...
class karyawan_probationlist extends Controller {

	function karyawan_probationlist()
	{
		parent::Controller();	
...
$this->db->where('karyawan.status = "Probation"');
...
$this->db->order_by('karyawan__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('karyawan_probation_list_view', $data);
	}
}
