...
class receive_items_lineview extends Controller {

	function receive_items_lineview()
	{
		parent::Controller();	
...
$this->db->where('id', $receive_items_line_id);
$this->db->select('*');
...
$this->load->view('receive_items_line_view_form', $data);
}
...
$this->db->where('id', $data['receive_items_line_id']);
