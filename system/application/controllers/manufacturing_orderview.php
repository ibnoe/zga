...
class manufacturing_orderview extends Controller {

	function manufacturing_orderview()
	{
		parent::Controller();	
...
$this->load->view('manufacturing_order_view_form', $data);
}
...
$this->db->where('id', $data['manufacturing_order_id']);
