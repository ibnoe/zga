...
class purchase_invoice_line_viewlist extends Controller {

	function purchase_invoice_line_viewlist()
	{
		parent::Controller();	
	...
	function _qhelp($data, $purchaseinvoice_id)
	{
		
$this->db->where('purchaseinvoiceline.purchaseinvoice_id', $purchaseinvoice_id);$this->db->from('purchaseinvoiceline');
...
$this->db->order_by('purchaseinvoiceline__lastupdate', 'desc');
	...
	function index($purchaseinvoice_id=0)
	{
		$data = array();
		...
		$data['foreign_id'] = $purchaseinvoice_id;$data['fields'] = array('item__name' => 'Item', 'purchaseinvoiceline__quantity' => 'Quantity', 'uom__name' => 'Unit', 'purchaseinvoiceline__price' => 'Price', 'purchaseinvoiceline__subtotal' => 'SubTotal', 'purchaseinvoiceline__lastupdate' => 'Last Update', 'purchaseinvoiceline__updatedby' => 'Last Update By');
		
		$data = $this->_qhelp($data, $purchaseinvoice_id);
		...
		///
		$this->load->view('purchase_invoice_line_view_list_view', $data);
	}
}
