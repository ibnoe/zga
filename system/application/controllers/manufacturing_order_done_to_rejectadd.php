...
class manufacturing_order_done_to_rejectadd extends Controller {
...
$data['manufacturingorderdoneline__createdby'] = '';
		...
		$this->load->view('manufacturing_order_done_to_reject_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('manufacturing_order_done_to_rejectadd','manufacturingorderdoneline','aftersave', $manufacturingorderdoneline_id);
