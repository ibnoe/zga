...
class delivery_noteedit extends Controller {

	function delivery_noteedit()
	{
		parent::Controller();	
...
$this->load->view('delivery_note_edit_form', $data);
}
...
$this->generallib->commonfunction('delivery_noteedit','deliveryorder','afteredit', $_POST['delivery_order_id']);
