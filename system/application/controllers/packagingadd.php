...
class packagingadd extends Controller {
...
$data['item__idstring'] = $this->generallib->genId('Packaging');
$data['item__name'] = '';
$data['item__packagingtype'] = '';
$data['item__minquantity'] = '';
$data['item__maxquantity'] = '';
$data['item__buffer3months'] = '';
$data['item__expiryduration'] = '';
$data['item__expirydate'] = '';
$data['item__intitemtype'] = 'packaging';
$data['item__itemcategory_id'] = '12';
...
$data['item__createdby'] = '';
		...
		$this->load->view('packaging_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('packagingadd','item','aftersave', $item_id);
