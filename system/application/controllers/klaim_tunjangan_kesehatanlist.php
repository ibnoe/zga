...
class klaim_tunjangan_kesehatanlist extends Controller {

	function klaim_tunjangan_kesehatanlist()
	{
		parent::Controller();	
...
$this->db->where('tunjangankesehatanusage.karyawan_id', $karyawan_id);$this->db->from('tunjangankesehatanusage');
...
$this->db->select('tunjangankesehatanusage.updatedby as tunjangankesehatanusage__updatedby', false);
		...
		if (isset($_POST['searchtext']) && $_POST['searchtext'] != "")
		{
			...
			$where .= "tunjangankesehatanusage.date like '%".$_POST['searchtext']."%'";$where .= " || tunjangankesehatanusage.description like '%".$_POST['searchtext']."%'";$where .= " || tunjangankesehatanusage.amount like '%".$_POST['searchtext']."%'";$where .= " || tunjangankesehatanusage.amountpaid like '%".$_POST['searchtext']."%'";$where .= " || tunjangankesehatanusage.notes like '%".$_POST['searchtext']."%'";$where .= " || tunjangankesehatanusage.lastupdate like '%".$_POST['searchtext']."%'";$where .= " || tunjangankesehatanusage.updatedby like '%".$_POST['searchtext']."%'";
...
$this->db->order_by('tunjangankesehatanusage__date', 'asc');
...
$this->db->order_by('tunjangankesehatanusage__lastupdate', 'desc');
	...
	function index($karyawan_id=0)
	{
		...
		$data['foreign_id'] = $karyawan_id;$data['fields'] = array('tunjangankesehatanusage__date' => 'Date', 'tunjangankesehatanusage__description' => 'Receipt From', 'tunjangankesehatanusage__amount' => 'Total Receipt', 'tunjangankesehatanusage__amountpaid' => 'Company Paid', 'tunjangankesehatanusage__notes' => 'Notes', 'tunjangankesehatanusage__lastupdate' => 'Last Update', 'tunjangankesehatanusage__updatedby' => 'Last Update By');
		...
		///
		$this->load->view('klaim_tunjangan_kesehatan_list_view', $data);
	}
}
