...
$data['deliveryorder__createdby'] = '';if (isset($_POST['date']) && $_POST['date'] != -1){$data['deliveryorder__date'] = $_POST['date'];}if (isset($_POST['orderid']) && $_POST['orderid'] != -1){$data['deliveryorder__orderid'] = $_POST['orderid'];}if (isset($_POST['donum']) && $_POST['donum'] != -1){$data['deliveryorder__donum'] = $_POST['donum'];}if (isset($_POST['dodate']) && $_POST['dodate'] != -1){$data['deliveryorder__dodate'] = $_POST['dodate'];}if (isset($_POST['customer_id']) && $_POST['customer_id'] != -1){$data['deliveryorder__customer_id'] = $_POST['customer_id'];}if (isset($_POST['warehouse_id']) && $_POST['warehouse_id'] != -1){$data['deliveryorder__warehouse_id'] = $_POST['warehouse_id'];}if (isset($_POST['deliveredby']) && $_POST['deliveredby'] != -1){$data['deliveryorder__deliveredby'] = $_POST['deliveredby'];}if (isset($_POST['vehicleno']) && $_POST['vehicleno'] != -1){$data['deliveryorder__vehicleno'] = $_POST['vehicleno'];}if (isset($_POST['notes']) && $_POST['notes'] != -1){$data['deliveryorder__notes'] = $_POST['notes'];}if (isset($_POST['lastupdate']) && $_POST['lastupdate'] != -1){$data['deliveryorder__lastupdate'] = $_POST['lastupdate'];}if (isset($_POST['updatedby']) && $_POST['updatedby'] != -1){$data['deliveryorder__updatedby'] = $_POST['updatedby'];}if (isset($_POST['created']) && $_POST['created'] != -1){$data['deliveryorder__created'] = $_POST['created'];}if (isset($_POST['createdby']) && $_POST['createdby'] != -1){$data['deliveryorder__createdby'] = $_POST['createdby'];}
...
$error .= $this->generallib->commonfunction('delivery_orderadd','deliveryorder','aftersave', $deliveryorder_id);
