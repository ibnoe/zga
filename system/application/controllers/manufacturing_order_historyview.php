...
class manufacturing_order_historyview extends Controller {

	function manufacturing_order_historyview()
	{
		parent::Controller();	
...
$this->db->where('id', $manufacturing_order_history_id);
$this->db->select('*');
...
$this->load->view('manufacturing_order_history_view_form', $data);
}
...
$this->db->where('id', $data['manufacturing_order_history_id']);
