...
class manufacturing_order_waiting_listadd extends Controller {
...
$data['manufacturingorder__idstring'] = $this->generallib->genId('Manufacturing Order Waiting List');
...
$data['manufacturingorder__createdby'] = '';
		...
		$this->load->view('manufacturing_order_waiting_list_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('manufacturing_order_waiting_listadd','manufacturingorder','aftersave', $manufacturingorder_id);
