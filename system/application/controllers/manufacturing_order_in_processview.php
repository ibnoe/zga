...
class manufacturing_order_in_processview extends Controller {

	function manufacturing_order_in_processview()
	{
		parent::Controller();	
...
$this->db->where('id', $manufacturing_order_in_process_id);
$this->db->select('*');
...
$this->load->view('manufacturing_order_in_process_view_form', $data);
}
...
$this->db->where('id', $data['manufacturing_order_in_process_id']);
