...
class giro_in_clearance_lineadd extends Controller {
...
$data['giroinclearanceline__createdby'] = '';
		...
		$this->load->view('giro_in_clearance_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('giro_in_clearance_lineadd','giroinclearanceline','aftersave', $giroinclearanceline_id);
