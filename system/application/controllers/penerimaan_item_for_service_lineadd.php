...
class penerimaan_item_for_service_lineadd extends Controller {
...
$data['insertitemline__createdby'] = $insertitem['createdby'];
		...
		$this->load->view('penerimaan_item_for_service_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('penerimaan_item_for_service_lineadd','insertitemline','aftersave', $insertitemline_id);
