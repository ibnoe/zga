...
class karyawan_probationadd extends Controller {
...
$data['karyawan__createdby'] = '';
		...
		$this->load->view('karyawan_probation_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('karyawan_probationadd','karyawan','aftersave', $karyawan_id);
