...
class purchase_payment_lineadd extends Controller {
...
$data['purchasepaymentline__createdby'] = '';
		...
		$this->load->view('purchase_payment_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('purchase_payment_lineadd','purchasepaymentline','aftersave', $purchasepaymentline_id);
