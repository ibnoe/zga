...
class cuti_to_processedview extends Controller {

	function cuti_to_processedview()
	{
		parent::Controller();	
...
$this->db->where('id', $cuti_to_processed_id);
$this->db->select('*');
...
$this->load->view('cuti_to_processed_view_form', $data);
}
...
$this->db->where('id', $data['cuti_to_processed_id']);
