...
class insert_item_lineedit extends Controller {

	function insert_item_lineedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $insert_item_line_id);
$this->db->select('*');
...
$this->load->view('insert_item_line_edit_form', $data);
}
...
$this->db->where('id', $_POST['insert_item_line_id']);
$this->db->update('insertitemline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('insert_item_lineedit','insertitemline','afteredit', $_POST['insert_item_line_id']);
