...
class item_in_stockadd extends Controller {
...
$data['item__idstring'] = $this->generallib->genId('Item In Stock');
$data['item__name'] = '';
...
$data['item__createdby'] = '';
		...
		$this->load->view('item_in_stock_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('item_in_stockadd','item','aftersave', $item_id);
