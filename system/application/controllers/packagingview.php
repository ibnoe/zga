...
class packagingview extends Controller {
...
$this->load->view('packaging_view_form', $data);
}
...
$data['packagingtype'] = $_POST['item__packagingtype'];
...
$this->db->where('id', $data['packaging_id']);
