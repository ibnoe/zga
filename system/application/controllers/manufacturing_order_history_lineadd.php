...
class manufacturing_order_history_lineadd extends Controller {
...
$data['manufacturingorderdoneline__createdby'] = '';
		...
		$this->load->view('manufacturing_order_history_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('manufacturing_order_history_lineadd','manufacturingorderdoneline','aftersave', $manufacturingorderdoneline_id);
