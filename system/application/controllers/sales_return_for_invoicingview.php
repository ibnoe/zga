...
class sales_return_for_invoicingview extends Controller {

	function sales_return_for_invoicingview()
	{
		parent::Controller();	
...
$this->db->where('id', $sales_return_for_invoicing_id);
$this->db->select('*');
...
$this->load->view('sales_return_for_invoicing_view_form', $data);
}
...
$this->db->where('id', $data['sales_return_for_invoicing_id']);
