...
class sales_order_open_paymentlist extends Controller {

	function sales_order_open_paymentlist()
	{
		parent::Controller();	
...
$this->db->where('salesorder.total > salesorder.totalpaid');
...
$this->db->order_by('salesorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('sales_order_open_payment_list_view', $data);
	}
}
