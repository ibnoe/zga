...
class purchase_payment_lineview extends Controller {

	function purchase_payment_lineview()
	{
		parent::Controller();	
...
$this->db->where('id', $purchase_payment_line_id);
$this->db->select('*');
...
$this->load->view('purchase_payment_line_view_form', $data);
}
...
$this->db->where('id', $data['purchase_payment_line_id']);
