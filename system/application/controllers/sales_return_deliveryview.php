...
class sales_return_deliveryview extends Controller {

	function sales_return_deliveryview()
	{
		parent::Controller();	
...
$this->load->view('sales_return_delivery_view_form', $data);
}
...
$this->db->where('id', $data['sales_return_delivery_id']);
