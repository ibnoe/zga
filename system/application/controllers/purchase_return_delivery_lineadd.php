...
class purchase_return_delivery_lineadd extends Controller {
...
$data['purchasereturndeliveryline__createdby'] = '';
		...
		$this->load->view('purchase_return_delivery_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('purchase_return_delivery_lineadd','purchasereturndeliveryline','aftersave', $purchasereturndeliveryline_id);
