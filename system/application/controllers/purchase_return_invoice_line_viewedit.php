...
class purchase_return_invoice_line_viewedit extends Controller {

	function purchase_return_invoice_line_viewedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $purchase_return_invoice_line_view_id);
...
$this->load->view('purchase_return_invoice_line_view_edit_form', $data);
}
...
$this->db->where('id', $_POST['purchase_return_invoice_line_view_id']);
$this->db->update('purchasereturninvoiceline', $data);
$this->load->library('generallib');
$this->generallib->commonfunction('purchase_return_invoice_line_viewedit','purchasereturninvoiceline','afteredit', $_POST['purchase_return_invoice_line_view_id']);
