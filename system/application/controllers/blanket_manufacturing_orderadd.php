...
class blanket_manufacturing_orderadd extends Controller {
...
$data['manufacturingorder__idstring'] = $this->generallib->genId('Blanket Manufacturing Order');
...
$data['manufacturingorder__bif_id'] = '';
$item_opt = array();
$item_opt[''] = 'None';
$q = $this->db->get('item');
if ($q->num_rows() > 0)
...
$data['manufacturingorder__type'] = 'blanket_manufacturing_order';
...
$data['manufacturingorder__createdby'] = '';
		...
		$this->load->view('blanket_manufacturing_order_add_form', $data);
	}
...
if (!isset($_POST['manufacturingorder__bif_id']) || ($_POST['manufacturingorder__bif_id'] == "" || $_POST['manufacturingorder__bif_id'] == null  || $_POST['manufacturingorder__bif_id'] == null))
...
$error .= $this->generallib->commonfunction('blanket_manufacturing_orderadd','manufacturingorder','aftersave', $manufacturingorder_id);
