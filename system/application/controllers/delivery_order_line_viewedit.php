...
class delivery_order_line_viewedit extends Controller {

	function delivery_order_line_viewedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $delivery_order_line_view_id);
$this->db->select('*');
...
$this->load->view('delivery_order_line_view_edit_form', $data);
}
...
$this->db->where('id', $_POST['delivery_order_line_view_id']);
$this->db->update('deliveryorderline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('delivery_order_line_viewedit','deliveryorderline','afteredit', $_POST['delivery_order_line_view_id']);
