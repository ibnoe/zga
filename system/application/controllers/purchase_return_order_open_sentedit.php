...
class purchase_return_order_open_sentedit extends Controller {

	function purchase_return_order_open_sentedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $purchase_return_order_open_sent_id);
$this->db->select('*');
...
$this->load->view('purchase_return_order_open_sent_edit_form', $data);
}
...
if (isset($_POST['purchasereturnorder__purchasereturnorderid'])) {$this->db->where("id !=", $_POST['purchase_return_order_open_sent_id']);
...
$this->db->where('id', $_POST['purchase_return_order_open_sent_id']);
$this->db->update('purchasereturnorder', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('purchase_return_order_open_sentedit','purchasereturnorder','afteredit', $_POST['purchase_return_order_open_sent_id']);
