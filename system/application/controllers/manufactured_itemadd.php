...
class manufactured_itemadd extends Controller {
...
$data['item__idstring'] = $this->generallib->genId('Manufactured Item');
$data['item__name'] = '';
...
$data['item__createdby'] = '';
		...
		$this->load->view('manufactured_item_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('manufactured_itemadd','item','aftersave', $item_id);
