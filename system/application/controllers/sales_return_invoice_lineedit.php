...
class sales_return_invoice_lineedit extends Controller {

	function sales_return_invoice_lineedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $sales_return_invoice_line_id);
...
$this->load->view('sales_return_invoice_line_edit_form', $data);
}
...
$this->db->where('id', $_POST['sales_return_invoice_line_id']);
$this->db->update('salesreturninvoiceline', $data);
$this->load->library('generallib');
$this->generallib->commonfunction('sales_return_invoice_lineedit','salesreturninvoiceline','afteredit', $_POST['sales_return_invoice_line_id']);
