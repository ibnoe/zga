...
class purchase_return_order_open_sentlist extends Controller {

	function purchase_return_order_open_sentlist()
	{
		parent::Controller();	
...
$this->db->where('purchasereturnorder.totalquantity > purchasereturnorder.totalquantitysent');
...
$this->db->order_by('purchasereturnorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('purchase_return_order_open_sent_list_view', $data);
	}
}
