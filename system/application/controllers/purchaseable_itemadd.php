...
class purchaseable_itemadd extends Controller {
...
$data['item__idstring'] = $this->generallib->genId('Purchaseable Item');
$data['item__name'] = '';
...
$data['item__createdby'] = '';
		...
		$this->load->view('purchaseable_item_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('purchaseable_itemadd','item','aftersave', $item_id);
