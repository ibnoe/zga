...
class warehouseedit extends Controller {
...
$q = $this->db->where('id', $warehouse_id);
$this->db->select('*');
...
$this->load->view('warehouse_edit_form', $data);
}
...
$this->db->where('id', $_POST['warehouse_id']);
$this->db->update('warehouse', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('warehouseedit','warehouse','afteredit', $_POST['warehouse_id']);
