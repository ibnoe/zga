...
class packagingedit extends Controller {
...
$q = $this->db->where('id', $packaging_id);
$this->db->select('*');
...
$data['item__packagingtype'] = $r->packagingtype;
...
$this->load->view('packaging_edit_form', $data);
}
...
if (isset($_POST['item__idstring'])) {$this->db->where("id !=", $_POST['packaging_id']);
...
if (isset($_POST['item__expirydate']) && ($_POST['item__expirydate'] == "" || $_POST['item__expirydate'] == null))
...
$data['name'] = $_POST['item__name'];if (isset($_POST['item__packagingtype']))
$data['packagingtype'] = $_POST['item__packagingtype'];if (isset($_POST['item__minquantity']))
...
$data['buffer3months'] = $_POST['item__buffer3months'];if (isset($_POST['item__expiryduration']))
$data['expiryduration'] = $_POST['item__expiryduration'];if (isset($_POST['item__expirydate']))
$this->db->set('expirydate', "str_to_date('".$_POST['item__expirydate']."', '%d-%m-%Y')", false);if (isset($_POST['item__intitemtype']))
...
$this->db->where('id', $_POST['packaging_id']);
$this->db->update('item', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('packagingedit','item','afteredit', $_POST['packaging_id']);
