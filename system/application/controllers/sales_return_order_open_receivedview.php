...
class sales_return_order_open_receivedview extends Controller {

	function sales_return_order_open_receivedview()
	{
		parent::Controller();	
...
$this->db->where('id', $sales_return_order_open_received_id);
$this->db->select('*');
...
$this->load->view('sales_return_order_open_received_view_form', $data);
}
...
$this->db->where('id', $data['sales_return_order_open_received_id']);
