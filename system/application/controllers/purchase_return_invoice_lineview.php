...
class purchase_return_invoice_lineview extends Controller {

	function purchase_return_invoice_lineview()
	{
		parent::Controller();	
...
$this->db->where('id', $purchase_return_invoice_line_id);
$this->db->select('*');
...
$this->load->view('purchase_return_invoice_line_view_form', $data);
}
...
$this->db->where('id', $data['purchase_return_invoice_line_id']);
