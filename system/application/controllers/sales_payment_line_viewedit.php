...
class sales_payment_line_viewedit extends Controller {

	function sales_payment_line_viewedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $sales_payment_line_view_id);
$this->db->select('*');
...
$this->load->view('sales_payment_line_view_edit_form', $data);
}
...
$this->db->where('id', $_POST['sales_payment_line_view_id']);
$this->db->update('salespaymentline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('sales_payment_line_viewedit','salespaymentline','afteredit', $_POST['sales_payment_line_view_id']);
