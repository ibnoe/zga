...
class inventory_accountsadd extends Controller {
...
$data['coa__idstring'] = $this->generallib->genId('Inventory Accounts');
$data['coa__name'] = '';
$coatype_opt = array();
$coatype_opt[''] = 'None';
...
$data['coa__createdby'] = '';
		...
		$this->load->view('inventory_accounts_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('inventory_accountsadd','coa','aftersave', $coa_id);
