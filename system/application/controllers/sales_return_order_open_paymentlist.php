...
class sales_return_order_open_paymentlist extends Controller {

	function sales_return_order_open_paymentlist()
	{
		parent::Controller();	
...
$this->db->where('salesreturnorder.total > salesreturnorder.totalpaid');
...
$this->db->order_by('salesreturnorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('sales_return_order_open_payment_list_view', $data);
	}
}
