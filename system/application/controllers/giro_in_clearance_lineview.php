...
class giro_in_clearance_lineview extends Controller {

	function giro_in_clearance_lineview()
	{
		parent::Controller();	
...
$this->db->where('id', $giro_in_clearance_line_id);
$this->db->select('*');
...
$this->load->view('giro_in_clearance_line_view_form', $data);
}
...
$this->db->where('id', $data['giro_in_clearance_line_id']);
