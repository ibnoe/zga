...
class delivery_order_for_invoiceview extends Controller {

	function delivery_order_for_invoiceview()
	{
		parent::Controller();	
...
$this->db->where('id', $delivery_order_for_invoice_id);
$this->db->select('*');
...
$this->load->view('delivery_order_for_invoice_view_form', $data);
}
...
$this->db->where('id', $data['delivery_order_for_invoice_id']);
