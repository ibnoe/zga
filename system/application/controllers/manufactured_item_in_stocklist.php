...
class manufactured_item_in_stocklist extends Controller {

	function manufactured_item_in_stocklist()
	{
		parent::Controller();	
...
$this->db->order_by('item__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('manufactured_item_in_stock_list_view', $data);
	}
}
