...
class purchase_return_delivery_for_invoicelist extends Controller {

	function purchase_return_delivery_for_invoicelist()
	{
		parent::Controller();	
...
$this->db->order_by('purchasereturndelivery__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('purchase_return_delivery_for_invoice_list_view', $data);
	}
}
