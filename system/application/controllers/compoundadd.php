...
class compoundadd extends Controller {
...
$data['item__idstring'] = $this->generallib->genId('Compound');
$data['item__name'] = '';
$data['item__subcategory'] = '';
$data['item__expiryduration'] = '';
$data['item__expirydate'] = '';
$data['item__minquantity'] = '';
$data['item__maxquantity'] = '';
$data['item__buffer3months'] = '';
$data['item__intitemtype'] = 'compound';
$data['item__itemcategory_id'] = '9';
...
$data['item__createdby'] = '';
		...
		$this->load->view('compound_add_form', $data);
	}
...
$data['name'] = $_POST['item__name'];if (isset($_POST['item__subcategory']))
$data['subcategory'] = $_POST['item__subcategory'];if (isset($_POST['item__expiryduration']))
$data['expiryduration'] = $_POST['item__expiryduration'];if (isset($_POST['item__expirydate']))
$this->db->set('expirydate', "str_to_date('".$_POST['item__expirydate']."', '%d-%m-%Y')", false);if (isset($_POST['item__minquantity']))
...
$error .= $this->generallib->commonfunction('compoundadd','item','aftersave', $item_id);
