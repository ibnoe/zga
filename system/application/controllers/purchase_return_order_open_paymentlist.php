...
class purchase_return_order_open_paymentlist extends Controller {

	function purchase_return_order_open_paymentlist()
	{
		parent::Controller();	
...
$this->db->where('purchasereturnorder.total > purchasereturnorder.totalpaid');
...
$this->db->order_by('purchasereturnorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('purchase_return_order_open_payment_list_view', $data);
	}
}
