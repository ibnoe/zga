...
class purchase_orderedit extends Controller {

	function purchase_orderedit()
	{
		parent::Controller();	
	...
	function index($purchase_order_id=0)
	{
...
$q = $this->db->where('id', $purchase_order_id);
$this->db->select('*');
...
$data['purchaseorder__created'] = $r->created;
$data['purchaseorder__createdby'] = $r->createdby;}
$this->load->view('purchase_order_edit_form', $data);
}
...
if (isset($_POST['purchaseorder__orderid'])) {$this->db->where("id !=", $_POST['purchase_order_id']);
...
$this->db->set('estarrivaldate', "str_to_date('".$_POST['purchaseorder__estarrivaldate']."', '%d-%m-%Y')", false);
$data['lastupdate'] = date('Y-m-d H:i:s');
$data['updatedby'] = $this->session->userdata('user');
$data['created'] = date('Y-m-d H:i:s');
$data['createdby'] = $this->session->userdata('user');
$this->db->where('id', $_POST['purchase_order_id']);
$this->db->update('purchaseorder', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('purchase_orderedit','purchaseorder','afteredit', $_POST['purchase_order_id']);
