...
class roller_manufacturing_orderview extends Controller {

	function roller_manufacturing_orderview()
	{
		parent::Controller();	
...
$this->db->where('id', $roller_manufacturing_order_id);
$this->db->select('*');
...
$this->load->view('roller_manufacturing_order_view_form', $data);
}
...
$data['rcn_id'] = $_POST['manufacturingorder__rcn_id'];
...
$this->db->where('id', $data['roller_manufacturing_order_id']);
