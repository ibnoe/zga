...
class sales_order_open_paymentview extends Controller {

	function sales_order_open_paymentview()
	{
		parent::Controller();	
...
$this->db->where('id', $sales_order_open_payment_id);
$this->db->select('*');
...
$this->load->view('sales_order_open_payment_view_form', $data);
}
...
$this->db->where('id', $data['sales_order_open_payment_id']);
