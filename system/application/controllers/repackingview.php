...
class repackingview extends Controller {

	function repackingview()
	{
		parent::Controller();	
...
$this->load->view('repacking_view_form', $data);
}
...
$this->db->where('id', $data['repacking_id']);
