...
class sales_return_delivery_lineedit extends Controller {

	function sales_return_delivery_lineedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $sales_return_delivery_line_id);
$this->db->select('*');
...
$data['salesreturndeliveryline__salesreturnorderline_id'] = $r->salesreturnorderline_id;
...
$this->load->view('sales_return_delivery_line_edit_form', $data);
}
...
if (!isset($_POST['salesreturndeliveryline__item_id']) || ($_POST['salesreturndeliveryline__item_id'] == "" || $_POST['salesreturndeliveryline__item_id'] == null  || $_POST['salesreturndeliveryline__item_id'] == 0))
...
if (!isset($_POST['salesreturndeliveryline__uom_id']) || ($_POST['salesreturndeliveryline__uom_id'] == "" || $_POST['salesreturndeliveryline__uom_id'] == null  || $_POST['salesreturndeliveryline__uom_id'] == 0))
...
$this->db->where('id', $_POST['sales_return_delivery_line_id']);
$this->db->update('salesreturndeliveryline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('sales_return_delivery_lineedit','salesreturndeliveryline','afteredit', $_POST['sales_return_delivery_line_id']);
