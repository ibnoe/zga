...
class purchase_return_order_open_sentadd extends Controller {
...
$data['purchasereturnorder__purchasereturnorderid'] = $this->generallib->genId('Purchase Return Order Open Sent');
$supplier_opt = array();
$supplier_opt[''] = 'None';
...
$data['purchasereturnorder__updatedby'] = '';
		...
		$this->load->view('purchase_return_order_open_sent_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('purchase_return_order_open_sentadd','purchasereturnorder','aftersave', $purchasereturnorder_id);
