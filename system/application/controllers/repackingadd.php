...
class repackingadd extends Controller {
...
$data['manufacturingorder__idstring'] = $this->generallib->genId('Repacking');
...
$data['manufacturingorder__createdby'] = '';
		...
		$this->load->view('repacking_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('repackingadd','manufacturingorder','aftersave', $manufacturingorder_id);
