...
class insert_itemview extends Controller {

	function insert_itemview()
	{
		parent::Controller();	
...
$this->db->where('id', $insert_item_id);
$this->db->select('*');
...
$this->load->view('insert_item_view_form', $data);
}
...
$this->db->where('id', $data['insert_item_id']);
