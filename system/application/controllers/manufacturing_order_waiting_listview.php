...
class manufacturing_order_waiting_listview extends Controller {

	function manufacturing_order_waiting_listview()
	{
		parent::Controller();	
...
$this->db->where('id', $manufacturing_order_waiting_list_id);
$this->db->select('*');
...
$this->load->view('manufacturing_order_waiting_list_view_form', $data);
}
...
$data['quantitytoprocess'] = $_POST['manufacturingorder__quantitytoprocess'];
...
$this->db->where('id', $data['manufacturing_order_waiting_list_id']);
