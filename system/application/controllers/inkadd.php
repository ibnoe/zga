...
class inkadd extends Controller {
...
$data['item__idstring'] = $this->generallib->genId('Ink');
$data['item__name'] = '';
$data['item__inkcode'] = '';
$data['item__weight'] = '';
...
$data['item__intitemtype'] = 'ink';
$data['item__itemcategory_id'] = '7';
...
$data['item__createdby'] = '';
		...
		$this->load->view('ink_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('inkadd','item','aftersave', $item_id);
