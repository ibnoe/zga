...
class manufacturing_order_done_linelist extends Controller {

	function manufacturing_order_done_linelist()
	{
		parent::Controller();	
...
$this->db->order_by('manufacturingorderdoneline__lastupdate', 'desc');
	...
	function index($manufacturingorderdone_id=0)
	{
		...
		///
		$this->load->view('manufacturing_order_done_line_list_view', $data);
	}
}
