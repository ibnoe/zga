...
class purchase_order_open_receivededit extends Controller {

	function purchase_order_open_receivededit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $purchase_order_open_received_id);
$this->db->select('*');
...
$this->load->view('purchase_order_open_received_edit_form', $data);
}
...
if (isset($_POST['purchaseorder__orderid'])) {$this->db->where("id !=", $_POST['purchase_order_open_received_id']);
...
$this->db->where('id', $_POST['purchase_order_open_received_id']);
$this->db->update('purchaseorder', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('purchase_order_open_receivededit','purchaseorder','afteredit', $_POST['purchase_order_open_received_id']);
