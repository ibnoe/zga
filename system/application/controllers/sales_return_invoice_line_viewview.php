...
class sales_return_invoice_line_viewview extends Controller {

	function sales_return_invoice_line_viewview()
	{
		parent::Controller();	
...
$this->db->where('id', $sales_return_invoice_line_view_id);
$this->db->select('*');
...
$this->load->view('sales_return_invoice_line_view_view_form', $data);
}
...
$this->db->where('id', $data['sales_return_invoice_line_view_id']);
