...
class sales_return_invoice_line_viewadd extends Controller {
...
$data['salesreturninvoiceline__createdby'] = '';
		...
		$this->load->view('sales_return_invoice_line_view_add_form', $data);
	}
...
$data = array();
$data['salesreturninvoice_id'] = $_POST['salesreturninvoice_id'];if (isset($_POST['salesreturninvoiceline__item_id']))
...
$this->generallib->commonfunction('sales_return_invoice_line_viewadd','salesreturninvoiceline','aftersave', $salesreturninvoiceline_id);
...
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('sales_return_invoice_line_viewadd','salesreturninvoiceline','validation', 0, $valdata);
