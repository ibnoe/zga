...
class depreciation_accountsadd extends Controller {
...
$data['coa__idstring'] = $this->generallib->genId('Depreciation Accounts');
$data['coa__name'] = '';
$coatype_opt = array();
$coatype_opt[''] = 'None';
...
$data['coa__createdby'] = '';
		...
		$this->load->view('depreciation_accounts_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('depreciation_accountsadd','coa','aftersave', $coa_id);
