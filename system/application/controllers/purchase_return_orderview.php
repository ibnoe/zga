...
class purchase_return_orderview extends Controller {

	function purchase_return_orderview()
	{
		parent::Controller();	
...
$this->db->where('id', $purchase_return_order_id);
$this->db->select('*');
...
$this->load->view('purchase_return_order_view_form', $data);
}
...
$data['created'] = $_POST['purchasereturnorder__created'];
$data['createdby'] = $_POST['purchasereturnorder__createdby'];
$this->db->where('id', $data['purchase_return_order_id']);
