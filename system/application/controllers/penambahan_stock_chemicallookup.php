...
class penambahan_stock_chemicallookup extends Controller {

	function penambahan_stock_chemicallookup()
	{
		parent::Controller();	
...
$this->db->order_by('penambahanstockchemical__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('penambahan_stock_chemical_lookup_view', $data);
	}
}
