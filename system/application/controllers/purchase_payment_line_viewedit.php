...
class purchase_payment_line_viewedit extends Controller {

	function purchase_payment_line_viewedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $purchase_payment_line_view_id);
$this->db->select('*');
...
$this->load->view('purchase_payment_line_view_edit_form', $data);
}
...
$this->db->where('id', $_POST['purchase_payment_line_view_id']);
$this->db->update('purchasepaymentline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('purchase_payment_line_viewedit','purchasepaymentline','afteredit', $_POST['purchase_payment_line_view_id']);
