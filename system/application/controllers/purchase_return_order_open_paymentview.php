...
class purchase_return_order_open_paymentview extends Controller {

	function purchase_return_order_open_paymentview()
	{
		parent::Controller();	
...
$this->db->where('id', $purchase_return_order_open_payment_id);
$this->db->select('*');
...
$this->load->view('purchase_return_order_open_payment_view_form', $data);
}
...
$this->db->where('id', $data['purchase_return_order_open_payment_id']);
