...
class delivery_order_line_viewadd extends Controller {
...
$data['deliveryorderline__createdby'] = '';
		...
		$this->load->view('delivery_order_line_view_add_form', $data);
	}
...
$data = array();
$data['deliveryorder_id'] = $_POST['deliveryorder_id'];if (isset($_POST['deliveryorderline__item_id']))
...
$error .= $this->generallib->commonfunction('delivery_order_line_viewadd','deliveryorderline','aftersave', $deliveryorderline_id);
