...
class penerimaan_item_for_serviceadd extends Controller {
...
$data['insertitem__idstring'] = $this->generallib->genId('Penerimaan Item For Service');
...
$data['insertitem__createdby'] = '';
		...
		$this->load->view('penerimaan_item_for_service_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('penerimaan_item_for_serviceadd','insertitem','aftersave', $insertitem_id);
