...
class cuti_to_processlist extends Controller {

	function cuti_to_processlist()
	{
		parent::Controller();	
...
$this->db->where('cutiklaim.status = "Approved"');
$this->db->where('cutiklaim.processed = 0');
...
$this->db->order_by('cutiklaim__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('cuti_to_process_list_view', $data);
	}
}
