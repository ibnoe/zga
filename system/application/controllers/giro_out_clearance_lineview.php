...
class giro_out_clearance_lineview extends Controller {

	function giro_out_clearance_lineview()
	{
		parent::Controller();	
...
$this->db->where('id', $giro_out_clearance_line_id);
$this->db->select('*');
...
$this->load->view('giro_out_clearance_line_view_form', $data);
}
...
$this->db->where('id', $data['giro_out_clearance_line_id']);
