...
class manufacturing_order_already_doneadd extends Controller {
...
$data['manufacturingorder__idstring'] = $this->generallib->genId('Manufacturing Order Already Done');
...
$data['manufacturingorder__createdby'] = '';
		...
		$this->load->view('manufacturing_order_already_done_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('manufacturing_order_already_doneadd','manufacturingorder','aftersave', $manufacturingorder_id);
