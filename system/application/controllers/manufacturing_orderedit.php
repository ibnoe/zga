...
class manufacturing_orderedit extends Controller {

	function manufacturing_orderedit()
	{
		parent::Controller();	
	...
	function index($manufacturing_order_id=0)
	{
...
$q = $this->db->where('id', $manufacturing_order_id);
$this->db->select('*');
...
$this->load->view('manufacturing_order_edit_form', $data);
}
...
if (isset($_POST['manufacturingorder__idstring'])) {$this->db->where("id !=", $_POST['manufacturing_order_id']);
...
$this->db->where('id', $_POST['manufacturing_order_id']);
$this->db->update('manufacturingorder', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('manufacturing_orderedit','manufacturingorder','afteredit', $_POST['manufacturing_order_id']);
