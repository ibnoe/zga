...
class from_warehouseadd extends Controller {
...
$data['warehouse__createdby'] = '';
		...
		$this->load->view('from_warehouse_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('from_warehouseadd','warehouse','aftersave', $warehouse_id);
