...
class barview extends Controller {
...
$data['item__barcode'] = $r->barcode;
$data['item__length'] = $r->length;
$data['item__pressmodel'] = $r->pressmodel;
...
$this->load->view('bar_view_form', $data);
}
...
$data['barcode'] = $_POST['item__barcode'];
$data['length'] = $_POST['item__length'];
$data['pressmodel'] = $_POST['item__pressmodel'];
