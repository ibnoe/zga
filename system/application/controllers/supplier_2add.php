...
class supplier_2add extends Controller {
...
$data['supplier__idstring'] = $this->generallib->genId('Supplier 2');
...
$data['supplier__createdby'] = '';
		...
		$this->load->view('supplier_2_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('supplier_2add','supplier','aftersave', $supplier_id);
