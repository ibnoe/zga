...
class delivery_noteadd extends Controller {
...
$data['deliveryorderline_data'][$salesorderline_id] = $linedata;
		...
		$this->load->view('delivery_note_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('delivery_noteadd','deliveryorder','validation', 0, $valdata);
...
$this->load->library('generallib');
$this->generallib->commonfunction('delivery_noteadd','deliveryorder','aftersave', $deliveryorder_id);
