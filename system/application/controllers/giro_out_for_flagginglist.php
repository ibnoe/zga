...
class giro_out_for_flagginglist extends Controller {

	function giro_out_for_flagginglist()
	{
		parent::Controller();	
...
$this->db->where('giroout.usedflag = 0');
...
$this->db->order_by('giroout__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('giro_out_for_flagging_list_view', $data);
	}
}
