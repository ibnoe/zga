...
class stock_movement_line_viewview extends Controller {

	function stock_movement_line_viewview()
	{
		parent::Controller();	
...
$this->db->where('id', $stock_movement_line_view_id);
$this->db->select('*');
...
$this->load->view('stock_movement_line_view_view_form', $data);
}
...
$this->db->where('id', $data['stock_movement_line_view_id']);
