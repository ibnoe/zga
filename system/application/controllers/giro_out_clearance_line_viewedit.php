...
class giro_out_clearance_line_viewedit extends Controller {

	function giro_out_clearance_line_viewedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $giro_out_clearance_line_view_id);
$this->db->select('*');
...
$this->load->view('giro_out_clearance_line_view_edit_form', $data);
}
...
$this->db->where('id', $_POST['giro_out_clearance_line_view_id']);
$this->db->update('girooutclearanceline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('giro_out_clearance_line_viewedit','girooutclearanceline','afteredit', $_POST['giro_out_clearance_line_view_id']);
