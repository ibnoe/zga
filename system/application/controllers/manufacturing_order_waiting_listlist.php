...
class manufacturing_order_waiting_listlist extends Controller {

	function manufacturing_order_waiting_listlist()
	{
		parent::Controller();	
...
$this->db->order_by('manufacturingorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('manufacturing_order_waiting_list_list_view', $data);
	}
}
