...
class reject_manufacturing_line_viewview extends Controller {

	function reject_manufacturing_line_viewview()
	{
		parent::Controller();	
...
$this->db->where('id', $reject_manufacturing_line_view_id);
$this->db->select('*');
...
$this->load->view('reject_manufacturing_line_view_view_form', $data);
}
...
$this->db->where('id', $data['reject_manufacturing_line_view_id']);
