...
class chemical_manufacturing_orderadd extends Controller {
...
$data['manufacturingorder__idstring'] = $this->generallib->genId('Chemical Manufacturing Order');
...
$data['manufacturingorder__penambahanstockchemical_id'] = '';
$item_opt = array();
$item_opt[''] = 'None';
$q = $this->db->get('item');
if ($q->num_rows() > 0)
...
$data['manufacturingorder__createdby'] = '';
		...
		$this->load->view('chemical_manufacturing_order_add_form', $data);
	}
...
if (!isset($_POST['manufacturingorder__penambahanstockchemical_id']) || ($_POST['manufacturingorder__penambahanstockchemical_id'] == "" || $_POST['manufacturingorder__penambahanstockchemical_id'] == null  || $_POST['manufacturingorder__penambahanstockchemical_id'] == null))
...
$error .= $this->generallib->commonfunction('chemical_manufacturing_orderadd','manufacturingorder','aftersave', $manufacturingorder_id);
