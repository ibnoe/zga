...
class itemedit extends Controller {
...
$this->load->view('item_edit_form', $data);
}
...
if (isset($_POST['item__idstring'])) {$this->db->where("id !=", $_POST['item_id']);
...
if (!isset($_POST['item__itemcategory_id']) || ($_POST['item__itemcategory_id'] == "" || $_POST['item__itemcategory_id'] == null  || $_POST['item__itemcategory_id'] == 0))
...
$error .= $this->generallib->commonfunction('itemedit','item','afteredit', $_POST['item_id']);
