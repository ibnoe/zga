...
class manufacturing_reject_reasonlookup extends Controller {

	function manufacturing_reject_reasonlookup()
	{
		parent::Controller();	
...
$this->db->order_by('manufacturingrejectreason__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('manufacturing_reject_reason_lookup_view', $data);
	}
}
