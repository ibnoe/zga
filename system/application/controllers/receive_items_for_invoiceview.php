...
class receive_items_for_invoiceview extends Controller {

	function receive_items_for_invoiceview()
	{
		parent::Controller();	
...
$this->db->where('id', $receive_items_for_invoice_id);
$this->db->select('*');
...
$this->load->view('receive_items_for_invoice_view_form', $data);
}
...
$this->db->where('id', $data['receive_items_for_invoice_id']);
