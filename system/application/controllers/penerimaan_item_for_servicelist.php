...
class penerimaan_item_for_servicelist extends Controller {

	function penerimaan_item_for_servicelist()
	{
		parent::Controller();	
...
$this->db->order_by('insertitem__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('penerimaan_item_for_service_list_view', $data);
	}
}
