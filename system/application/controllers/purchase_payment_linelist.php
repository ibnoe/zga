...
class purchase_payment_linelist extends Controller {

	function purchase_payment_linelist()
	{
		parent::Controller();	
	...
	function _qhelp($data, $purchasepayment_id)
	{
		
$this->db->where('purchasepaymentline.purchasepayment_id', $purchasepayment_id);$this->db->from('purchasepaymentline');
...
$this->db->order_by('purchasepaymentline__lastupdate', 'desc');
	...
	function index($purchasepayment_id=0)
	{
		$data = array();
		...
		$data['foreign_id'] = $purchasepayment_id;$data['fields'] = array('purchaseinvoice__orderid' => 'Purchase Invoice', 'purchasepaymentline__lastupdate' => 'Last Update', 'purchasepaymentline__updatedby' => 'Last Update By');
		...
		$data = $this->_qhelp($data, $purchasepayment_id);
		...
		///
		$this->load->view('purchase_payment_line_list_view', $data);
	}
}
