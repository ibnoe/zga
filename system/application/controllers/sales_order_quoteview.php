...
class sales_order_quoteview extends Controller {

	function sales_order_quoteview()
	{
		parent::Controller();	
...
$this->db->where('id', $sales_order_quote_id);
$this->db->select('*');
...
$data['salesorder__grandtotal'] = $r->grandtotal;
...
$this->load->view('sales_order_quote_view_form', $data);
}
...
$data['status'] = $_POST['salesorder__status'];
...
$data['grandtotal'] = $_POST['salesorder__grandtotal'];
$data['lastupdate'] = $_POST['salesorder__lastupdate'];
$data['updatedby'] = $_POST['salesorder__updatedby'];
$data['created'] = $_POST['salesorder__created'];
$data['createdby'] = $_POST['salesorder__createdby'];
$this->db->where('id', $data['sales_order_quote_id']);
