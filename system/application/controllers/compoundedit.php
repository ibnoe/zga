...
class compoundedit extends Controller {
...
$q = $this->db->where('id', $compound_id);
$this->db->select('*');
...
$this->load->view('compound_edit_form', $data);
}
...
if (isset($_POST['item__idstring'])) {$this->db->where("id !=", $_POST['compound_id']);
...
$this->db->where('id', $_POST['compound_id']);
$this->db->update('item', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('compoundedit','item','afteredit', $_POST['compound_id']);
