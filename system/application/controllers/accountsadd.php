...
class accountsadd extends Controller {
...
$data['coa__idstring'] = $this->generallib->genId('Accounts');
$data['coa__name'] = '';
$coatype_opt = array();
$coatype_opt[''] = 'None';
...
$data['coa__createdby'] = '';
		...
		$this->load->view('accounts_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('accountsadd','coa','aftersave', $coa_id);
