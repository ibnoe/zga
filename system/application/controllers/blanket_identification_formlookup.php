...
class blanket_identification_formlookup extends Controller {

	function blanket_identification_formlookup()
	{
		parent::Controller();	
...
$this->db->order_by('bif__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('blanket_identification_form_lookup_view', $data);
	}
}
