...
class manufactured_item_in_stocklookup extends Controller {

	function manufactured_item_in_stocklookup()
	{
		parent::Controller();	
...
$this->db->where('item.manufactured = 1');
...
$this->db->order_by('item__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('manufactured_item_in_stock_lookup_view', $data);
	}
}
