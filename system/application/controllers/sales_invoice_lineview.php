...
class sales_invoice_lineview extends Controller {

	function sales_invoice_lineview()
	{
		parent::Controller();	
...
$this->db->where('id', $sales_invoice_line_id);
$this->db->select('*');
...
$this->load->view('sales_invoice_line_view_form', $data);
}
...
$this->db->where('id', $data['sales_invoice_line_id']);
