...
class manufacturing_orderadd extends Controller {
...
$data['manufacturingorder__idstring'] = $this->generallib->genId('Manufacturing Order');
...
$data['manufacturingorder__type'] = 'manufacturing_order';
...
$data['manufacturingorder__createdby'] = '';
		...
		$this->load->view('manufacturing_order_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('manufacturing_orderadd','manufacturingorder','aftersave', $manufacturingorder_id);
