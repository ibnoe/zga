...
class from_warehouseview extends Controller {

	function from_warehouseview()
	{
		parent::Controller();	
...
$this->db->where('id', $from_warehouse_id);
$this->db->select('*');
...
$this->load->view('from_warehouse_view_form', $data);
}
...
$this->db->where('id', $data['from_warehouse_id']);
