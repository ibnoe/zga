...
class delivery_order_for_invoicelist extends Controller {

	function delivery_order_for_invoicelist()
	{
		parent::Controller();	
...
$this->db->order_by('deliveryorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('delivery_order_for_invoice_list_view', $data);
	}
}
