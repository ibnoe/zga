...
class manufacturing_order_historyadd extends Controller {
...
$data['manufacturingorderdone__idstring'] = $this->generallib->genId('Manufacturing Order History');
...
$data['manufacturingorderdoneline_data'][$manufacturingorder_id] = $linedata;
		...
		$this->load->view('manufacturing_order_history_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('manufacturing_order_historyadd','manufacturingorderdone','aftersave', $manufacturingorderdone_id);
