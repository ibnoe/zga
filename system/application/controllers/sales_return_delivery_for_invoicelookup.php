...
class sales_return_delivery_for_invoicelookup extends Controller {

	function sales_return_delivery_for_invoicelookup()
	{
		parent::Controller();	
...
$this->db->order_by('salesreturndelivery__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('sales_return_delivery_for_invoice_lookup_view', $data);
	}
}
