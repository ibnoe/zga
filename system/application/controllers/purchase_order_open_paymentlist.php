...
class purchase_order_open_paymentlist extends Controller {

	function purchase_order_open_paymentlist()
	{
		parent::Controller();	
...
$this->db->where('purchaseorder.total > purchaseorder.totalpaid');
...
$this->db->order_by('purchaseorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('purchase_order_open_payment_list_view', $data);
	}
}
