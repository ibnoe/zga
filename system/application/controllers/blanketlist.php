...
class blanketlist extends Controller {

	function blanketlist()
	{
		parent::Controller();	
...
$this->db->order_by('item__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('blanket_list_view', $data);
	}
}
