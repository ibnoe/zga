...
class coreedit extends Controller {
...
$this->load->view('core_edit_form', $data);
}
...
if (isset($_POST['item__idstring'])) {$this->db->where("id !=", $_POST['core_id']);
...
$data['subcategory'] = $_POST['item__subcategory'];if (isset($_POST['item__coreno']))
$data['coreno'] = $_POST['item__coreno'];if (isset($_POST['item__presstype']))
$data['presstype'] = $_POST['item__presstype'];if (isset($_POST['item__minquantity']))
...
$this->db->where('id', $_POST['core_id']);
$this->db->update('item', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('coreedit','item','afteredit', $_POST['core_id']);
