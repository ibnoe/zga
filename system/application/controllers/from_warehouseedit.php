...
class from_warehouseedit extends Controller {

	function from_warehouseedit()
	{
		parent::Controller();	
	...
	function index($from_warehouse_id=0)
	{
...
$q = $this->db->where('id', $from_warehouse_id);
$this->db->select('*');
...
$this->load->view('from_warehouse_edit_form', $data);
}
...
$this->db->where('id', $_POST['from_warehouse_id']);
$this->db->update('warehouse', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('from_warehouseedit','warehouse','afteredit', $_POST['from_warehouse_id']);
