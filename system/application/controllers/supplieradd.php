...
class supplieradd extends Controller {
...
$data['supplier__idstring'] = $this->generallib->genId('Supplier');
...
$data['supplier__createdby'] = '';
		...
		$this->load->view('supplier_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('supplieradd','supplier','aftersave', $supplier_id);
