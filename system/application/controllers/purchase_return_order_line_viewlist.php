...
class purchase_return_order_line_viewlist extends Controller {

	function purchase_return_order_line_viewlist()
	{
		parent::Controller();	
	...
	function _qhelp($data, $purchasereturnorder_id)
	{
		
$this->db->where('purchasereturnorderline.purchasereturnorder_id', $purchasereturnorder_id);$this->db->from('purchasereturnorderline');
...
$this->db->order_by('purchasereturnorderline__lastupdate', 'desc');
	...
	function index($purchasereturnorder_id=0)
	{
		$data = array();
		...
		$data['foreign_id'] = $purchasereturnorder_id;$data['fields'] = array('item__name' => 'Item', 'purchasereturnorderline__quantitytosend' => 'Quantity', 'uom__name' => 'Unit', 'purchasereturnorderline__lastupdate' => 'Last Update', 'purchasereturnorderline__updatedby' => 'Last Update By');
		...
		$data = $this->_qhelp($data, $purchasereturnorder_id);
		...
		///
		$this->load->view('purchase_return_order_line_view_list_view', $data);
	}
}
