...
class to_warehouseadd extends Controller {
...
$data['warehouse__createdby'] = '';
		...
		$this->load->view('to_warehouse_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('to_warehouseadd','warehouse','aftersave', $warehouse_id);
