...
class chemical_manufacturing_orderview extends Controller {

	function chemical_manufacturing_orderview()
	{
		parent::Controller();	
...
$this->db->where('id', $chemical_manufacturing_order_id);
$this->db->select('*');
...
$this->load->view('chemical_manufacturing_order_view_form', $data);
}
...
$data['penambahanstockchemical_id'] = $_POST['manufacturingorder__penambahanstockchemical_id'];
...
$this->db->where('id', $data['chemical_manufacturing_order_id']);
