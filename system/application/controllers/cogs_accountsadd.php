...
class cogs_accountsadd extends Controller {
...
$data['coa__idstring'] = $this->generallib->genId('COGS Accounts');
$data['coa__name'] = '';
$coatype_opt = array();
$coatype_opt[''] = 'None';
...
$data['coa__createdby'] = '';
		...
		$this->load->view('cogs_accounts_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('cogs_accountsadd','coa','aftersave', $coa_id);
