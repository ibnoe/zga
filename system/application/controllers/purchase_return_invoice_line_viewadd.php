...
class purchase_return_invoice_line_viewadd extends Controller {
	...
	function index($id = 0)
	{
		...
		$data['purchasereturninvoice_id'] = $id;
$item_opt = array();
$item_opt[''] = 'None';
$q = $this->db->get('item');
if ($q->num_rows() > 0)
...
$data['purchasereturninvoiceline__createdby'] = '';
		...
		$this->load->view('purchase_return_invoice_line_view_add_form', $data);
	}
...
$data = array();
$data['purchasereturninvoice_id'] = $_POST['purchasereturninvoice_id'];if (isset($_POST['purchasereturninvoiceline__item_id']))
...
$this->generallib->commonfunction('purchase_return_invoice_line_viewadd','purchasereturninvoiceline','aftersave', $purchasereturninvoiceline_id);
...
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('purchase_return_invoice_line_viewadd','purchasereturninvoiceline','validation', 0, $valdata);
