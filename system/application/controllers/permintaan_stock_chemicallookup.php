...
class permintaan_stock_chemicallookup extends Controller {

	function permintaan_stock_chemicallookup()
	{
		parent::Controller();	
...
$this->db->order_by('permintaanstockchemical__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('permintaan_stock_chemical_lookup_view', $data);
	}
}
