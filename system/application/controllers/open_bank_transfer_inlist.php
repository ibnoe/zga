...
class open_bank_transfer_inlist extends Controller {

	function open_bank_transfer_inlist()
	{
		parent::Controller();	
...
$this->db->where('banktransfermasuk.transferedflag = 0');
...
$this->db->select('banktransfermasuk.id as banktransfermasuk__id', false);
...
$this->db->select('banktransfermasuk.updatedby as banktransfermasuk__updatedby', false);
		...
		if (isset($_POST['searchtext']) && $_POST['searchtext'] != "")
		{
			...
			$where .= "banktransfermasuk.id like '%".$_POST['searchtext']."%'";$where .= " || banktransfermasuk.idstring like '%".$_POST['searchtext']."%'";$where .= " || banktransfermasuk.date like '%".$_POST['searchtext']."%'";$where .= " || currency.name like '%".$_POST['searchtext']."%'";$where .= " || banktransfermasuk.amount like '%".$_POST['searchtext']."%'";$where .= " || banktransfermasuk.notes like '%".$_POST['searchtext']."%'";$where .= " || banktransfermasuk.transferedflag like '%".$_POST['searchtext']."%'";$where .= " || banktransfermasuk.lastupdate like '%".$_POST['searchtext']."%'";$where .= " || banktransfermasuk.updatedby like '%".$_POST['searchtext']."%'";
...
$this->db->order_by('banktransfermasuk__id', 'asc');
...
$this->db->order_by('banktransfermasuk__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('open_bank_transfer_in_list_view', $data);
	}
}
