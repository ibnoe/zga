...
class receive_items_lineedit extends Controller {

	function receive_items_lineedit()
	{
		parent::Controller();	
	...
	function index($receive_items_line_id=0)
	{
		if ($receive_items_line_id == 0)
		{
...
$this->load->view('receive_items_line_edit_form', $data);
}
...
$this->db->where('id', $_POST['receive_items_line_id']);
$this->db->update('receiveditemline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('receive_items_lineedit','receiveditemline','afteredit', $_POST['receive_items_line_id']);
