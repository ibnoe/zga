...
class stock_movement_lineadd extends Controller {
...
$data['moveactionline__createdby'] = '';
		...
		$this->load->view('stock_movement_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('stock_movement_lineadd','moveactionline','aftersave', $moveactionline_id);
