...
class purchase_order_open_paymentedit extends Controller {

	function purchase_order_open_paymentedit()
	{
		parent::Controller();	
	...
	function index($purchase_order_open_payment_id=0)
	{
		if ($purchase_order_open_payment_id == 0)
		{
...
$q = $this->db->where('id', $purchase_order_open_payment_id);
$this->db->select('*');
...
if ($q->num_rows() > 0) {
$data = array();
$data['purchase_order_open_payment_id'] = $purchase_order_open_payment_id;
...
$this->load->view('purchase_order_open_payment_edit_form', $data);
}
...
if (isset($_POST['purchaseorder__orderid'])) {$this->db->where("id !=", $_POST['purchase_order_open_payment_id']);
...
if (!isset($_POST['purchaseorder__supplier_id']) || ($_POST['purchaseorder__supplier_id'] == "" || $_POST['purchaseorder__supplier_id'] == null  || $_POST['purchaseorder__supplier_id'] == 0))
$error .= "<span class='error'>Supplier must not be empty"."</span><br>";

if (!isset($_POST['purchaseorder__currency_id']) || ($_POST['purchaseorder__currency_id'] == "" || $_POST['purchaseorder__currency_id'] == null  || $_POST['purchaseorder__currency_id'] == 0))
...
if (isset($_FILES['purchaseorder__quote1']) && $_FILES['purchaseorder__quote1']['tmp_name'] != null && $_FILES['purchaseorder__quote1']['tmp_name'] != ""){$filepath = 'upload//'.$_FILES['purchaseorder__quote1']['name'];move_uploaded_file($_FILES['purchaseorder__quote1']['tmp_name'], $filepath);$data['quote1'] = $_FILES['purchaseorder__quote1']['name'];}if (isset($_POST['purchaseorder__notes']))
...
if (isset($_FILES['purchaseorder__quote2']) && $_FILES['purchaseorder__quote2']['tmp_name'] != null && $_FILES['purchaseorder__quote2']['tmp_name'] != ""){$filepath = 'upload//'.$_FILES['purchaseorder__quote2']['name'];move_uploaded_file($_FILES['purchaseorder__quote2']['tmp_name'], $filepath);$data['quote2'] = $_FILES['purchaseorder__quote2']['name'];}if (isset($_POST['purchaseorder__notes2']))
...
if (isset($_FILES['purchaseorder__quote3']) && $_FILES['purchaseorder__quote3']['tmp_name'] != null && $_FILES['purchaseorder__quote3']['tmp_name'] != ""){$filepath = 'upload//'.$_FILES['purchaseorder__quote3']['name'];move_uploaded_file($_FILES['purchaseorder__quote3']['tmp_name'], $filepath);$data['quote3'] = $_FILES['purchaseorder__quote3']['name'];}if (isset($_POST['purchaseorder__notes3']))
...
$this->db->where('id', $_POST['purchase_order_open_payment_id']);
$this->db->update('purchaseorder', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('purchase_order_open_paymentedit','purchaseorder','afteredit', $_POST['purchase_order_open_payment_id']);
