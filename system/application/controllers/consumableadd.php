...
class consumableadd extends Controller {
...
$data['item__idstring'] = $this->generallib->genId('Consumable');
$data['item__name'] = '';
...
$data['item__intitemtype'] = 'consumable';
$data['item__itemcategory_id'] = '11';
...
$data['item__createdby'] = '';
		...
		$this->load->view('consumable_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('consumableadd','item','aftersave', $item_id);
