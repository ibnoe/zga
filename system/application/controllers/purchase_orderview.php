...
class purchase_orderview extends Controller {

	function purchase_orderview()
	{
		parent::Controller();	
...
$this->load->view('purchase_order_view_form', $data);
}
...
$data['created'] = $_POST['purchaseorder__created'];
$data['createdby'] = $_POST['purchaseorder__createdby'];
$this->db->where('id', $data['purchase_order_id']);
