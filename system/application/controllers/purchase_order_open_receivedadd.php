...
class purchase_order_open_receivedadd extends Controller {
...
$data['purchaseorder__orderid'] = $this->generallib->genId('Purchase Order Open Received');
...
$data['purchaseorder__updatedby'] = '';
		...
		$this->load->view('purchase_order_open_received_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('purchase_order_open_receivedadd','purchaseorder','aftersave', $purchaseorder_id);
