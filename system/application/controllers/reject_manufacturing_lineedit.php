...
class reject_manufacturing_lineedit extends Controller {

	function reject_manufacturing_lineedit()
	{
		parent::Controller();	
...
$q = $this->db->where('id', $reject_manufacturing_line_id);
$this->db->select('*');
...
$this->load->view('reject_manufacturing_line_edit_form', $data);
}
...
$this->db->where('id', $_POST['reject_manufacturing_line_id']);
$this->db->update('rejectmanufacturingline', $data);
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('reject_manufacturing_lineedit','rejectmanufacturingline','afteredit', $_POST['reject_manufacturing_line_id']);
