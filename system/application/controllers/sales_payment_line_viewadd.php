...
class sales_payment_line_viewadd extends Controller {
...
$data['salespaymentline__createdby'] = '';
		...
		$this->load->view('sales_payment_line_view_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('sales_payment_line_viewadd','salespaymentline','aftersave', $salespaymentline_id);
