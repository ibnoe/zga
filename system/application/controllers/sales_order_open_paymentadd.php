...
class sales_order_open_paymentadd extends Controller {
...
$data['salesorder__orderid'] = $this->generallib->genId('Sales Order Open Payment');
...
$data['salesorder__updatedby'] = '';
		...
		$this->load->view('sales_order_open_payment_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('sales_order_open_paymentadd','salesorder','aftersave', $salesorder_id);
