...
class purchase_return_payment_linelist extends Controller {

	function purchase_return_payment_linelist()
	{
		parent::Controller();	
	...
	function _qhelp($data, $purchasereturnpayment_id)
	{
		
$this->db->where('purchasereturnpaymentline.purchasereturnpayment_id', $purchasereturnpayment_id);$this->db->from('purchasereturnpaymentline');
...
$this->db->order_by('purchasereturnpaymentline__lastupdate', 'desc');
	...
	function index($purchasereturnpayment_id=0)
	{
		$data = array();
		...
		$data['foreign_id'] = $purchasereturnpayment_id;$data['fields'] = array('purchasereturninvoice__purchasereturninvoiceid' => 'Purchase Return Invoice', 'purchasereturnpaymentline__lastupdate' => 'Last Update', 'purchasereturnpaymentline__updatedby' => 'Last Update By');
		...
		$data = $this->_qhelp($data, $purchasereturnpayment_id);
		...
		///
		$this->load->view('purchase_return_payment_line_list_view', $data);
	}
}
