...
class delivery_order_lineview extends Controller {

	function delivery_order_lineview()
	{
		parent::Controller();	
...
$this->db->where('id', $delivery_order_line_id);
$this->db->select('*');
...
$this->load->view('delivery_order_line_view_form', $data);
}
...
$this->db->where('id', $data['delivery_order_line_id']);
