...
class sales_return_invoice_linelist extends Controller {

	function sales_return_invoice_linelist()
	{
		parent::Controller();	
	...
	{
		$this->db->from('salesreturninvoiceline');
...
$this->db->order_by('salesreturninvoiceline__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		$data['fields'] = array('item__name' => 'Item', 'salesreturninvoiceline__quantity' => 'Quantity', 'uom__name' => 'Unit', 'salesreturninvoiceline__price' => 'Price', 'salesreturninvoiceline__subtotal' => 'SubTotal', 'salesreturninvoiceline__lastupdate' => 'Last Update', 'salesreturninvoiceline__updatedby' => 'Last Update By');
		...
		///
		$this->load->view('sales_return_invoice_line_list_view', $data);
	}
}
