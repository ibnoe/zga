...
class inkview extends Controller {
...
$this->load->view('ink_view_form', $data);
}
...
$data['inkcode'] = $_POST['item__inkcode'];
$data['weight'] = $_POST['item__weight'];
