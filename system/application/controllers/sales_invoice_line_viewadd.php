...
class sales_invoice_line_viewadd extends Controller {
...
$data['salesinvoiceline__createdby'] = '';
		...
		$this->load->view('sales_invoice_line_view_add_form', $data);
	}
...
$data = array();
$data['salesinvoice_id'] = $_POST['salesinvoice_id'];if (isset($_POST['salesinvoiceline__item_id']))
...
$this->generallib->commonfunction('sales_invoice_line_viewadd','salesinvoiceline','aftersave', $salesinvoiceline_id);
...
$this->load->library('generallib');
$error .= $this->generallib->commonfunction('sales_invoice_line_viewadd','salesinvoiceline','validation', 0, $valdata);
