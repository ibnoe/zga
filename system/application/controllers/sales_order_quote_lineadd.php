...
class sales_order_quote_lineadd extends Controller {
...
$data['salesorderline__modulename'] = 'sales_order_quote_line';
...
$data['salesorderline__status'] = $salesorder['status'];
...
$data['salesorderline__createdby'] = $salesorder['createdby'];
		...
		$this->load->view('sales_order_quote_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('sales_order_quote_lineadd','salesorderline','aftersave', $salesorderline_id);
