...
class purchase_order_open_receivedlist extends Controller {

	function purchase_order_open_receivedlist()
	{
		parent::Controller();	
...
$this->db->where('purchaseorder.totalquantity > purchaseorder.totalquantitysent');
...
$this->db->order_by('purchaseorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('purchase_order_open_received_list_view', $data);
	}
}
