...
$data['receiveditem__createdby'] = '';if (isset($_POST['date'])){$data['receiveditem__date'] = $_POST['date'];}if (isset($_POST['orderid'])){$data['receiveditem__orderid'] = $_POST['orderid'];}if (isset($_POST['suratjalanno'])){$data['receiveditem__suratjalanno'] = $_POST['suratjalanno'];}if (isset($_POST['supplier_id'])){$data['receiveditem__supplier_id'] = $_POST['supplier_id'];}if (isset($_POST['warehouse_id'])){$data['receiveditem__warehouse_id'] = $_POST['warehouse_id'];}if (isset($_POST['lastupdate'])){$data['receiveditem__lastupdate'] = $_POST['lastupdate'];}if (isset($_POST['updatedby'])){$data['receiveditem__updatedby'] = $_POST['updatedby'];}if (isset($_POST['created'])){$data['receiveditem__created'] = $_POST['created'];}if (isset($_POST['createdby'])){$data['receiveditem__createdby'] = $_POST['createdby'];}
...
if (isset($qq->row()->mfgdate))
$linedata['receiveditemline__mfgdate'] = $qq->row()->mfgdate;
else
$linedata['receiveditemline__mfgdate'] = null;
...
if (isset($qq->row()->batchno))
$linedata['receiveditemline__batchno'] = $qq->row()->batchno;
else
$linedata['receiveditemline__batchno'] = null;
if (isset($qq->row()->palletno))
$linedata['receiveditemline__palletno'] = $qq->row()->palletno;
else
$linedata['receiveditemline__palletno'] = null;
if (isset($qq->row()->rollno))
$linedata['receiveditemline__rollno'] = $qq->row()->rollno;
else
$linedata['receiveditemline__rollno'] = null;
...
$idx = str_replace('receiveditem__', '', $k);
if ($v != null)
$valdata[$idx] = $v;
}
...
$data['date'] = $_POST['receiveditem__date'];if (isset($_POST['receiveditem__orderid']))
...
if (isset($_POST['receiveditemline__mfgdate'][$i]))
$coldata[$i]['mfgdate'] = $_POST['receiveditemline__mfgdate'][$i];
if (isset($_POST['receiveditemline__expireddate'][$i]))
$coldata[$i]['expireddate'] = $_POST['receiveditemline__expireddate'][$i];
if (isset($_POST['receiveditemline__batchno'][$i]))
$coldata[$i]['batchno'] = $_POST['receiveditemline__batchno'][$i];
if (isset($_POST['receiveditemline__palletno'][$i]))
$coldata[$i]['palletno'] = $_POST['receiveditemline__palletno'][$i];
if (isset($_POST['receiveditemline__rollno'][$i]))
$coldata[$i]['rollno'] = $_POST['receiveditemline__rollno'][$i];
...
$this->load->library('generallib');
$this->generallib->commonfunction('receive_itemsadd','receiveditem','aftersave', $receiveditem_id);
	
			
			

$error .= $this->generallib->commonfunction('receive_itemsadd','receiveditem','validation', $receiveditem_id, $valdata);
