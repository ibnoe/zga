...
class sales_order_open_sentlist extends Controller {

	function sales_order_open_sentlist()
	{
		parent::Controller();	
...
$this->db->where('salesorder.totalquantity > salesorder.totalquantitysent');
...
$this->db->order_by('salesorder__lastupdate', 'desc');
	...
	function index($edit_module_id=0)
	{
		...
		///
		$this->load->view('sales_order_open_sent_list_view', $data);
	}
}
