...
class core_repairview extends Controller {

	function core_repairview()
	{
		parent::Controller();	
...
$this->db->where('id', $core_repair_id);
$this->db->select('*');
...
$this->load->view('core_repair_view_form', $data);
}
...
$this->db->where('id', $data['core_repair_id']);
