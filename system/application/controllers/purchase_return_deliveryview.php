...
class purchase_return_deliveryview extends Controller {

	function purchase_return_deliveryview()
	{
		parent::Controller();	
...
$this->load->view('purchase_return_delivery_view_form', $data);
}
...
$this->db->where('id', $data['purchase_return_delivery_id']);
