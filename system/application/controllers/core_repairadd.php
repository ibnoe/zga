...
class core_repairadd extends Controller {
...
$data['manufacturingorder__idstring'] = $this->generallib->genId('Core Repair');
...
$data['manufacturingorder__type'] = 'core_repair';
...
$data['manufacturingorder__createdby'] = '';
		...
		$this->load->view('core_repair_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('core_repairadd','manufacturingorder','aftersave', $manufacturingorder_id);
