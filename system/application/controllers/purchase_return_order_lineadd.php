...
class purchase_return_order_lineadd extends Controller {
...
$data['purchasereturnorderline__createdby'] = '';
		...
		$this->load->view('purchase_return_order_line_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('purchase_return_order_lineadd','purchasereturnorderline','aftersave', $purchasereturnorderline_id);
