...
class sales_return_order_open_paymentadd extends Controller {
...
$data['salesreturnorder__salesreturnorderid'] = $this->generallib->genId('Sales Return Order Open Payment');
$customer_opt = array();
$customer_opt[''] = 'None';
...
$data['salesreturnorder__updatedby'] = '';
		...
		$this->load->view('sales_return_order_open_payment_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('sales_return_order_open_paymentadd','salesreturnorder','aftersave', $salesreturnorder_id);
