...
class purchase_return_payment_line_viewview extends Controller {

	function purchase_return_payment_line_viewview()
	{
		parent::Controller();	
...
$this->db->where('id', $purchase_return_payment_line_view_id);
$this->db->select('*');
...
$this->load->view('purchase_return_payment_line_view_view_form', $data);
}
...
$this->db->where('id', $data['purchase_return_payment_line_view_id']);
