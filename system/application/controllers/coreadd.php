...
class coreadd extends Controller {
...
$data['item__idstring'] = $this->generallib->genId('Core');
$data['item__name'] = '';
...
$data['item__intitemtype'] = 'core';
$data['item__itemcategory_id'] = '4';
...
$data['item__createdby'] = '';
		...
		$this->load->view('core_add_form', $data);
	}
...
$error .= $this->generallib->commonfunction('coreadd','item','aftersave', $item_id);
